...
loc_13B8:
    ...
    exg d0,d7
loc_13C4:
    jmp loc_13C8-2(pc,d0.w) ; VIOLATION: invalid overlap: pc-relative reference targets +2 into instruction at $13C4 | invalid overlap: instruction bytes at +2 are referenced by reachable pc-relative operand
loc_13C8:
    bra.w loc_140E
loc_13CC:
    bra.s loc_138E
...
loc_7542:
    ...
    move.w (a0)+,d3
    move.w (a0)+,d2
    pea.l dat_7578+156(pc) ; VIOLATION: pc-relative target $7614 has no exact data label; rendered as data-span label $7578+156
...
dat_7578:
    ...
    DC.B    "Nu n"
    DC.L    $017a42ae,$017a4ed0,$b23c000a,$671eb23c,$00096718,$b23c0020,$6712b23c,$002a670c
    DC.L    $b23c003b,$6706700e,$61000e50,$4aae017a,$66cc4aae,$018e671a,$222e018e,$42ae018e
    DC.L    $d3ae023c,$4a816b04,$d3ae0224,$42ae0182,$4e75220d,$92ae024c,$2d410182,$6714242e
    DC.L    $023cd3ae,$023cd3ae,$02244a2e,$02386600,$20924e75
sub_7680:
    bsr.s sub_76B8
loc_7682:
    bne.s loc_76A0
...
loc_8F72:
    moveq.l #9,d3
    lea.l dat_8F90+8(pc),a2 ; VIOLATION: pc-relative target $8F98 has no exact data label; rendered as data-span label $8F90+8
    lea.l dat_8F80(pc),a4
    bra.w loc_8A26
dat_8F80:
    DC.B    $0c,$2b,$00,$02,$00,$0d,$67,$08,$10,$2b,$00,$0e,$60,$00,$07,$f8
dat_8F90:
    DC.L    $6100ff04,$6000fefc,$48e710a0,$2f087015,$6100fed8,$205741e8,$00161418,$12186100
    DC.L    $fee85302,$6ef66100,$fed46100,$fed0205f,$45e80010,$610c4cdf,$05084e75
loc_8FCC:
    jmp loc_06A4.l
sub_8FD2:
    move.l a2,d0
...
loc_9AF0:
    add.w d0,d0
    add.w d0,d0
    lea.l dat_9B6A+56(pc),a2 ; VIOLATION: pc-relative target $9BA2 has no exact data label; rendered as data-span label $9B6A+56
...
loc_9C7C:
    ...
    movea.l a0,a4
    move.l #$3F0,(a4)+
    lea.l dat_9D02+40(pc),a2 ; VIOLATION: pc-relative target $9D2A has no exact data label; rendered as data-span label $9D02+40
    movea.l $013E(a6),a1
    movea.l $0004(a3),a0
    bsr.w sub_8CF6
loc_9C96:
...
dat_9D02:
    ...
    DC.L    $de815087,$4e75bc29,$000e66d0,$0c290001,$000d66c8,$610c2029,$0008d0ab,$000828c0
    DC.B    $4e,$75
sub_9D46:
    moveq.l #0,d1
    move.b $0016(a1),d1
...
loc_9FD4:
    movea.l $013E(a6),a1
    lea.l dat_A034+24(pc),a2 ; VIOLATION: pc-relative target $A04C has no exact data label; rendered as data-span label $A034+24
    bsr.w sub_8CF6
loc_9FE0:
    moveq.l #0,d1
    bsr.w loc_A0EE
...
dat_A034:
    ...
    DC.B    $61,$56,$22,$29,$00
    DC.B    $08,$60,$00
    DC.L    $00a64e75,$bc29000e,$66f80c29,$0001000d,$66f00829,$0004000c,$66e80c6e,$0003021c
    DC.L    $67124a2e,$01046a08,$08290005,$000c67d2,$700060c4,$302b0012,$b07c03ea,$670cb07c
    DC.L    $03e966ec,$52ae0214,$60e652ae,$021060e0
sub_A098:
    moveq.l #0,d1
    move.b $0016(a1),d1
    move.l d1,d2
...
loc_A3A6:
    rts
loc_A3A8:
    lea.l dat_A3CC+17(pc),a0 ; VIOLATION: pc-relative target $A3DD has no exact data label; rendered as data-span label $A3CC+17
    cmpi.w #3,$021C(a6)
    beq.s loc_A3A6
loc_A3B4:
    lea.l dat_A3BA+15(pc),a0 ; VIOLATION: pc-relative target $A3C9 has no exact data label; rendered as data-span label $A3BA+15
    rts
dat_A3BA:
...
loc_AA70:
    ...
    bne.s loc_AA9C
loc_AA84:
    lea.l dat_AAB6+62(pc),a0 ; VIOLATION: pc-relative target $AAF4 has no exact data label; rendered as data-span label $AAB6+62
    bsr.w sub_B0AC
loc_AA8C:
    bne.s loc_AA98
loc_AA8E:
    lea.l dat_AAB6+51(pc),a0 ; VIOLATION: pc-relative target $AAE9 has no exact data label; rendered as data-span label $AAB6+51
    bsr.w sub_B0AC
loc_AA96:
    beq.s loc_AA9C
loc_AA98:
...
loc_AC0E:
    movea.l (a7)+,a6
    lea.l dat_AC70+12(pc),a0 ; VIOLATION: pc-relative target $AC7C has no exact data label; rendered as data-span label $AC70+12
    bsr.w loc_9292
loc_AC18:
...
loc_AC4C:
    lea.l $000E(a7),a7
    lea.l dat_AC70+20(pc),a0 ; VIOLATION: pc-relative target $AC84 has no exact data label; rendered as data-span label $AC70+20
    bsr.w loc_9292
loc_AC58:
    lea.l app_dest_10B0+TV_SIZE(a6),a1
    move.l a6,-(a7)
...
loc_ACA8:
    ...
    beq.s loc_ACC2
loc_ACAE:
    lea.l dat_AC70+29(pc),a0 ; VIOLATION: pc-relative target $AC8D has no exact data label; rendered as data-span label $AC70+29
    move.l a0,d2
    moveq.l #21,d3
    move.l app_file_0CDA+fh_Link(a6),d1
    moveq.l #_LVOWrite,d0
...
loc_F9AA:
    ...
    rts
loc_F9B0:
    lea.l dat_F9B6+9(pc),a0 ; VIOLATION: pc-relative target $F9BF has no exact data label; rendered as data-span label $F9B6+9
    rts
dat_F9B6:
    DC.B    "S-record",0
    DC.B    $2e
...
loc_F9DE:
    ...
    bne.s loc_F9EA
loc_F9E6:
    lea.l dat_F9B6+13(pc),a2 ; VIOLATION: pc-relative target $F9C3 has no exact data label; rendered as data-span label $F9B6+13
loc_F9EA:
    moveq.l #0,d6
    moveq.l #0,d5
    movea.l a2,a0
