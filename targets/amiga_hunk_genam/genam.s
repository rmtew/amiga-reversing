...
loc_0_00000000:
	...
	dc.b $94,$4F,$7A,$30,$85,$C2,$24,$56,$45,$52,$3A,$20,$47,$65,$6E,$41
	dc.b $6D,$20,$33,$2E,$31,$38,$20,$28,$32,$2E,$38,$2E,$39,$34,$29,$00
...
loc_0_00000064:
	...
	sf.b app_0842(a6)
	st.b app_0843(a6)
	jsr loc_0_0000AB0E.l
	sf.b app_0102(a6)
	jsr loc_0_0000AB00.l
	sf.b app_0102(a6)
...
loc_0_00000436:
	...
	jsr loc_0_00008E7A.l
	moveq.l #0,d1
	move.w app_0192(a6),d1
	beq.b loc_0_0000046E
	jsr loc_0_00008F04.l
	moveq.l #13,d0
	jsr loc_0_00008E7A.l
	moveq.l #0,d0
	move.w app_0194(a6),d1
	jsr loc_0_00008F04.l
	moveq.l #14,d0
	jsr loc_0_00008E7A.l
loc_0_0000046E:
...
loc_0_00000496:
	...
	move.l d0,app_015A(a6)
	move.l d0,app_0162(a6)
	move.l d0,app_018E(a6)
	move.w d0,app_087E(a6)
	move.w d0,app_0880(a6)
	move.l d0,app_0882(a6)
	move.b d0,app_0106(a6)
	move.b d0,app_0112(a6)
	move.b d0,app_083B(a6)
	move.b d0,app_0121(a6)
	sf.b app_0123(a6)
	move.b d0,app_0122(a6)
	sf.b app_0124(a6)
	sf.b app_012C(a6)
	st.b app_012E(a6)
	sf.b app_012D(a6)
	move.w #$200,app_0130(a6)
	move.b d0,app_0132(a6)
	move.b d0,app_0133(a6)
	move.b #$1,app_085C(a6)
	move.b #$FF,app_086C(a6)
	sf.b app_0125(a6)
	move.b d0,app_012F(a6)
	move.w d0,app_010E(a6)
	move.w #$FFFF,app_0110(a6)
...
loc_0_000007F8:
	...
	tst.l app_0182(a6)
	beq.w loc_0_000008C6
	cmpi.b #1,app_0108(a6)
	bne.b loc_0_000007EE
	move.l app_017E(a6),d0
	beq.b loc_0_000007EE
	move.b app_0146(a6),d6
	movea.l d0,a0
	move.l $00AE(a0),d0
...
loc_0_00000BCE:
	movem.l a3-a5,-(a7)
	move.l app_015A(a6),d0
	beq.b loc_0_00000BE2
	movea.l d0,a2
	bsr.b loc_0_00000B88
	beq.b loc_0_00000BFC
	move.l a1,app_015E(a6)
loc_0_00000BE2:
	movea.l app_0162(a6),a2
	bsr.b loc_0_00000B88
	beq.b loc_0_00000BFC
	move.l a1,app_0166(a6)
	movea.l app_016A(a6),a2
	bsr.b loc_0_00000B88
	beq.b loc_0_00000BFC
	move.l a1,app_016E(a6)
	moveq.l #-1,d0
loc_0_00000BFC:
	movem.l (a7)+,a3-a5
	rts
...
loc_0_00000C84:
	...
	lea.l app_0162(a6),a2
	bra.b loc_0_00000CB6
loc_0_00000CAC:
	lea.l app_015A(a6),a2
	tst.l (a2)
...
loc_0_00000D06:
	...
	addq.l #1,d0
	bclr #0,d0
	sub.w d0,app_0148(a6)
	add.l d0,app_013A(a6)
	rts
loc_0_00000D20:
	cmp.w app_0148(a6),d0
...
loc_0_00000D34:
	...
	sub.l d0,app_013A(a6)
	add.w d0,app_0148(a6)
	move.l (a7)+,d0
	sub.w d0,app_0148(a6)
	add.l d0,app_013A(a6)
	rts
...
loc_0_00001032:
	...
	move.l d3,$4(a0,d0.w)
	rts
	dc.b $D4,$80,$B6,$3C,$00,$01,$67,$0E,$BC,$3C,$00,$01,$67,$0E,$02,$46
	dc.b $FF,$00,$86,$46,$4E,$75,$BC,$3C,$00,$01,$67,$06,$16,$3C,$00,$01
	dc.b $60,$EC,$4A,$2E,$01,$07,$66,$0E,$4A,$2E,$02,$38,$67,$0C,$70,$15
	dc.b $61,$00,$74,$04,$50,$C4,$76,$02,$4E,$75,$4A,$2E,$01,$58,$66,$EE
	dc.b $60,$F2,$70,$14,$60,$EA,$94,$80,$30,$03,$80,$46,$02,$40,$80,$00
	dc.b $4A,$46,$6B,$30,$BC,$3C,$00,$01,$66,$16,$08,$2E,$00,$01,$02,$1C
	dc.b $66,$0A,$08,$03,$00,$0F,$67,$04,$D4,$AE,$02,$3C,$55,$2E,$01,$0B
	dc.b $BC,$03,$67,$08,$BC,$3C,$00,$01,$66,$06,$61,$A6,$16,$3C,$00,$02
	dc.b $86,$40,$4E,$75,$61,$00,$69,$4A,$60,$E6,$61,$08,$61,$00,$00,$A0
	dc.b $76,$02,$4E,$75,$BC,$3C,$00,$01,$67,$88,$8C,$43,$6B,$A4,$B6,$3C
	dc.b $00,$01,$67,$00,$FF,$7E,$4E,$75,$61,$EA,$2F,$07,$61,$00,$00,$B4
	dc.b $4C,$DF,$00,$80,$66,$02,$4E,$75,$4A,$2E,$02,$38,$66,$00,$FF,$72
	dc.b $60,$00,$FF,$78,$C4,$80,$60,$CC,$84,$80,$60,$C8,$B1,$82,$60,$C4
	dc.b $E1,$AA,$60,$C0,$E0,$AA,$60,$BC,$B4,$80,$57,$C2,$48,$82,$48,$C2
	dc.b $30,$03,$80,$46,$6B,$00,$FF,$5C,$BC,$03,$67,$10,$B6,$3C,$00,$01
	dc.b $67,$00,$FF,$30,$BC,$3C,$00,$01,$67,$00,$FF,$28,$76,$02,$4E,$75
	dc.b $B4,$80,$56,$C2,$60,$D6,$B4,$80,$5D,$C2,$60,$D0,$B4,$80,$5E,$C2
	dc.b $60,$CA,$B4,$80,$5F,$C2,$60,$C4,$B4,$80,$5C,$C2,$60,$BE,$46,$82
	dc.b $B6,$7C,$00,$01,$67,$00,$FE,$FC,$4E,$75,$44,$82,$60,$F2,$2C,$02
	dc.b $B1,$86,$4A,$82,$6E,$02,$44,$82,$4A,$80,$6E,$02,$44,$80,$26,$02
	dc.b $48,$43,$C4,$C0,$48,$40,$4A,$43,$67,$04,$48,$40,$60,$06,$4A,$40
	dc.b $67,$08,$48,$43,$C0,$C3,$48,$40,$D4,$80,$4A,$86,$6A,$02,$44,$82
	dc.b $4E,$75,$4A,$80,$67,$4A,$2C,$02,$B1,$86,$2F,$06,$2F,$02,$4A,$80
	dc.b $6A,$02,$44,$80,$4A,$82,$6A,$02,$44,$82,$7C,$1F,$2E,$00,$70,$00
	dc.b $DE,$87,$55,$CE,$FF,$FC,$E2,$97,$04,$46,$00,$1F,$44,$46,$D0,$80
	dc.b $B4,$87,$65,$04,$52,$80,$94,$87,$E2,$8F,$51,$CE,$FF,$F2,$2C,$1F
	dc.b $6A,$02,$44,$82,$2C,$1F,$6A,$02,$44,$80,$C1,$42,$B0,$00,$4E,$75
	dc.b $70,$3D,$4E,$75,$20,$4C,$4E,$75
loc_0_00001208:
	moveq.l #0,d7
	ext.w d1
...
loc_0_000012D2:
	...
	dc.b $12,$1C,$B2,$3C,$00,$3D,$67,$16,$7E,$0F,$60,$2E,$7E,$0A,$12,$1C
	dc.b $B2,$3C,$00,$3C,$67,$20,$B2,$3C,$00,$3E,$67,$02,$60,$0E,$7E,$09
	dc.b $60,$16,$7E,$0B,$12,$1C,$B2,$3C,$00,$3E,$67,$0A,$B2,$3C,$00,$3D
	dc.b $66,$08,$54,$47,$60,$02,$59,$47,$12,$1C
loc_0_0000131C:
	movea.l (a7)+,a0
	movem.l (a7)+,d5-d6/a1-a2
	rts
loc_0_00001324:
	move.b app_012F(a6),d7
...
loc_0_00001358:
	...
	dc.b $70,$04,$16,$01,$12,$1C,$B2,$3C,$00,$0A,$67,$00,$00,$C2,$B2,$03
	dc.b $66,$0A,$12,$1C,$B2,$03,$67,$04,$76,$02,$60,$9A,$53,$00,$65,$00
	dc.b $00,$B8,$E1,$8A,$14,$01,$60,$DC,$12,$1C,$04,$01,$00,$30,$65,$00
	dc.b $00,$9E,$B2,$3C,$00,$02,$64,$00,$00,$96,$D4,$82,$65,$00,$00,$9A
	dc.b $84,$01,$12,$1C,$04,$01,$00,$30,$65,$7C,$B2,$3C,$00,$02,$65,$EA
	dc.b $60,$74
loc_0_000013B8:
	neg.b d7
	ext.w d7
	...
	exg d0,d7
	jmp $0(pc,d0.w)
	dc.b $60,$00,$00,$44,$60,$C0,$60,$00,$00,$16,$60,$92,$60,$00,$FF,$18
	dc.b $60,$00,$FF,$2A,$60,$00,$FF,$04,$72,$40,$60,$00,$FE,$EE,$10,$14
	dc.b $04,$00,$00,$30,$65,$F2,$B0,$3C,$00,$09,$64,$EC,$12,$00,$52,$8C
	dc.b $E7,$8A,$65,$42,$84,$01,$12,$1C,$04,$01,$00,$30,$65,$26,$B2,$3C
	dc.b $00,$09,$65,$EC,$60,$1E,$41,$FA,$00,$32,$72,$00,$12,$1C,$6B,$1C
	dc.b $12,$30,$10,$00,$6B,$16,$E9,$8A,$84,$01,$12,$1C,$6B,$06,$12,$30
	dc.b $10,$00,$6A,$F2,$12,$2C,$FF,$FF,$60,$00,$FE,$EA,$70,$16,$61,$00
	dc.b $70,$4E,$50,$C4,$60,$EE,$70,$17,$60,$F4
loc_0_00001442:
	dcb.b $30,$FF
...
loc_0_000016DC:
	...
	dc.b $C0,$42,$67,$EE,$20,$5F,$4E,$E8,$00,$02,$70,$25,$60,$00,$6D,$24
	dc.b $61,$1C,$66,$F6,$4A,$00,$66,$F2,$4E,$75,$61,$12,$66,$0C,$4A,$00
	dc.b $66,$06,$70,$10,$61,$00,$6D,$10,$B0,$00,$4E,$75,$60,$F4,$10,$01
	dc.b $20,$4C,$48,$80,$10,$36,$00,$7E,$B0,$3C,$00,$41,$67,$28,$B0,$3C
	dc.b $00,$44,$67,$22,$B0,$3C,$00,$52,$67,$4A,$B0,$3C,$00,$53,$66,$00
	dc.b $00,$7A,$10,$18,$48,$80,$10,$36,$00,$7E,$B0,$3C,$00,$50,$66,$6A
	dc.b $70,$01,$74,$07,$60,$14,$14,$18,$B4,$3C,$00,$37,$62,$5C,$04,$02
	dc.b $00,$30,$65,$56,$B0,$3C,$00,$41,$57,$C0,$02,$00,$00,$01,$72,$00
	dc.b $12,$18,$22,$7C
	dc.l loc_0_0000A764
	dc.b $4A,$31,$10,$00,$67,$3C,$28,$48,$B0,$00,$4E,$75,$14,$18,$B4,$3C
	dc.b $00,$39,$62,$2E,$B4,$3C,$00,$30,$65,$28,$B4,$3C,$00,$31,$66,$16
	dc.b $10,$10,$B0,$3C,$00,$36,$64,$0E,$B0,$3C,$00,$30,$65,$08,$06,$00
	dc.b $00,$0A,$14,$00,$52,$88,$04,$02,$00,$30,$B4,$3C,$00,$08,$54,$C0
	dc.b $60,$B0,$41,$EE,$04,$6E,$48,$E7,$00,$28,$12,$2C,$FF,$FF,$61,$00
	dc.b $5E,$58,$66,$3A,$24,$6E,$01,$6A,$48,$E7,$50,$1C,$61,$00,$F3,$52
	dc.b $4C,$DF,$38,$0A,$66,$28,$0C,$29,$00,$04,$00,$0D,$66,$20,$10,$29
	dc.b $00,$09,$14,$29,$00,$0B,$4A,$2E,$02,$38,$67,$08,$08,$29,$00,$06
	dc.b $00,$0C,$67,$0A,$4C,$DF,$05,$00,$24,$48,$B0,$00,$4E,$75,$4C,$DF
	dc.b $14,$00,$12,$2C,$FF,$FF,$70,$FF,$4E,$75,$4A,$2E,$01,$19,$67,$06
	dc.b $50,$EE,$01,$1A,$60,$04,$51,$EE,$01,$1A,$61,$00,$FE,$FA,$66,$18
	dc.b $7A,$00,$8A,$02,$4A,$00,$67,$0E,$00,$05,$00,$08,$0C,$2E,$00,$01
	dc.b $02,$39,$67,$00,$6B,$AE,$4E,$75,$24,$4C,$B2,$3C,$00,$28,$67,$00
	dc.b $01,$94,$B2,$3C,$00,$2D,$67,$00,$01,$C8,$B2,$3C,$00,$23,$67,$00
	dc.b $01,$E2,$48,$81,$12,$36,$10,$7E,$B2,$3C,$00,$43,$67,$42,$B2,$3C
	dc.b $00,$53,$67,$28,$B2,$3C,$00,$55,$66,$58,$12,$1C,$48,$81,$12,$36
	dc.b $10,$7E,$B2,$3C,$00,$53,$66,$4A,$12,$1C,$48,$81,$12,$36,$10,$7E
	dc.b $B2,$3C,$00,$50,$66,$3C,$7A,$04,$60,$00,$04,$0C,$12,$1C,$48,$81
	dc.b $12,$36,$10,$7E,$B2,$3C,$00,$52,$66,$28,$7A,$02,$60,$00,$03,$F8
	dc.b $12,$1C,$48,$81,$12,$36,$10,$7E,$B2,$3C,$00,$43,$66,$14,$12,$1C
	dc.b $48,$81,$12,$36,$10,$7E,$B2,$3C,$00,$52,$66,$06,$7A,$01,$60,$00
	dc.b $03,$D6,$28,$4A,$12,$2C,$FF,$FF,$61,$00,$F4,$84,$B2,$3C,$00,$28
	dc.b $67,$00,$01,$CE,$B2,$3C,$00,$2E,$67,$46,$B2,$3C,$00,$5C,$67,$40
	dc.b $4A,$2E,$01,$1C,$66,$52,$08,$2E,$00,$02,$01,$0F,$67,$28,$30,$42
	dc.b $B1,$C2,$66,$22,$4A,$04,$66,$1E,$B6,$3C,$00,$01,$67,$18,$61,$00
	dc.b $74,$66,$66,$12,$3A,$C2,$08,$C4,$00,$0F,$61,$00,$00,$76,$7A,$38
	dc.b $70,$0E,$60,$00,$6E,$8C,$4A,$2E,$01,$1A,$67,$3E,$60,$00,$02,$90
	dc.b $10,$14,$48,$80,$10,$36,$00,$7E,$B0,$3C,$00,$4C,$67,$22,$B0,$3C
	dc.b $00,$57,$66,$26,$52,$8C,$12,$1C,$7A,$38,$4A,$2E,$02,$38,$67,$0C
	dc.b $61,$00,$5F,$0C,$08,$84,$00,$0E,$61,$00,$00,$38,$3A,$C2,$4E,$75
	dc.b $52,$8C,$12,$1C,$08,$84,$00,$0F,$60,$04,$08,$C4,$00,$0F,$7A,$39
	dc.b $4A,$2E,$02,$38,$67,$18,$4A,$43,$6A,$06,$4E,$F9
	dc.l loc_0_000098FC
	...
	dc.b $4A,$43,$6A,$06,$4E,$F9
	dc.l loc_0_000098FC
	dc.b $B6,$3C,$00,$01,$66,$06,$4E,$B9
	dc.l loc_0_00009962
	dc.b $2A,$C2,$4E,$75,$4A,$2E,$02,$38,$67,$0E,$4A,$43,$6A,$06,$4E,$F9
	dc.l loc_0_00009938
	...
	dc.b $00,$07,$7A,$28,$8A,$02,$24,$1F,$12,$1C,$4A,$43,$6A,$06,$4E,$F9
	dc.l loc_0_0000991C
	...
	dc.b $66,$00,$F3,$E4,$12,$1C,$1A,$C3,$48,$43,$4A,$43,$6A,$06,$4E,$F9
	dc.l loc_0_00009946
...
loc_0_00001D14:
	...
	dc.b $67,$10,$3A,$C6,$4A,$43,$6B,$00,$78,$32,$61,$00,$57,$FC,$3A,$C2
	dc.b $4E,$75,$58,$8D,$4E,$75,$4A,$2E,$01,$2C,$6B,$94,$66,$00,$FF,$54
	dc.b $08,$2E,$00,$00,$01,$0F,$67,$D4,$61,$00,$EC,$D8,$4A,$04,$66,$46
	dc.b $4A,$2E,$01,$07,$66,$06,$B6,$3C,$00,$02,$67,$3A,$2F,$02,$94,$AE
	dc.b $02,$3C,$59,$82,$67,$2E,$6A,$02,$54,$82,$10,$02,$48,$80,$48,$C0
	dc.b $B4,$80,$66,$20,$61,$00,$6C,$C4,$66,$0C,$58,$8F,$8C,$02,$3A,$C6
	dc.b $70,$0C,$60,$00,$66,$F0,$08,$2E,$00,$05,$01,$0F,$67,$06,$70,$11
	dc.b $61,$00,$66,$E2,$24,$1F,$48,$7A,$FF,$88,$60,$04,$61,$00,$EC,$84
	dc.b $4A,$2E,$02,$38,$66,$10,$4A,$04,$66,$2E,$B6,$3C,$00,$02,$66,$28
	dc.b $4A,$2E,$01,$07,$66,$22,$4A,$43,$6B,$1E,$4A,$2E,$01,$07,$66,$06
	dc.b $B6,$3C,$00,$02,$67,$18,$08,$02,$00,$00,$67,$06,$70,$23,$61,$00
	dc.b $63,$22,$94,$AE,$02,$3C,$55,$82,$4A,$2E,$02,$38,$4E,$75,$70,$21
	dc.b $61,$00,$63,$10,$4A,$2E,$02,$38,$4E,$75,$B2,$3C,$00,$23,$66,$00
	dc.b $62,$E6,$12,$1C,$61,$00,$F5,$42,$4A,$82,$6B,$0E,$B4,$BC,$00,$00
	dc.b $00,$08,$64,$06,$8C,$02,$3A,$C6,$4E,$75,$3A,$C6,$70,$1D,$60,$00
	dc.b $62,$E2,$0C,$2E,$00,$14,$01,$21,$6D,$00,$0F,$84,$0C,$2E,$00,$20
	dc.b $01,$21,$67,$00,$0F,$7A,$4A,$2E,$02,$39,$66,$00,$62,$8A,$61,$00
	dc.b $F5,$9C,$02,$42,$00,$FF,$E8,$5A,$3A,$02,$B2,$3C,$00,$2C,$66,$00
	dc.b $62,$8E,$12,$1C,$61,$7E,$20,$6E,$02,$4C,$31,$45,$00,$02,$4E,$75
	dc.b $0C,$2E,$00,$14,$01,$21,$6D,$00,$0F,$46,$0C,$2E,$00,$20,$01,$21
	dc.b $67,$00,$0F,$3C,$4A,$2E,$02,$39,$66,$00,$62,$4C,$3A,$C6,$54,$8D
	dc.b $61,$00,$F4,$DA,$00,$65,$7A,$00,$61,$58,$B2,$3C,$00,$2C,$66,$00
	dc.b $62,$4E,$12,$1C,$61,$00,$F5,$46,$02,$42,$00,$FF,$E8,$5A,$8A,$42
	dc.b $20,$6E,$02,$4C,$31,$45,$00,$02,$4E,$75,$0C,$2E,$00,$14,$01,$21
	dc.b $6D,$00,$0E,$FC,$0C,$2E,$00,$20,$01,$21,$67,$00,$0E,$F2,$4A,$2E
	dc.b $02,$39,$66,$00,$62,$02,$7A,$00,$61,$0A,$20,$6E,$02,$4C,$31,$45
	dc.b $00,$02,$4E,$75,$3A,$C6,$54,$8D,$3F,$05,$61,$00,$F4,$80,$00,$25
	dc.b $3A,$1F,$B2,$3C,$00,$7B,$66,$1A,$12,$1C,$61,$00,$F5,$0E,$66,$18
	dc.b $4A,$00,$66,$0E,$08,$C5,$00,$0B,$02,$42,$00,$FF,$ED,$4A,$8A,$42
	dc.b $60,$28,$70,$55,$60,$00,$61,$F8,$61,$00,$F4,$3E,$4A,$2E,$02,$38
	dc.b $67,$18,$4A,$82,$6B,$08,$B4,$BC,$00,$00,$00,$20,$65,$04,$61,$00
	dc.b $56,$22,$ED,$4A,$02,$42,$07,$C0,$8A,$42,$B2,$3C,$00,$3A,$66,$D2
	dc.b $12,$1C,$61,$00,$F4,$C6,$66,$0C,$4A,$00,$66,$C6,$08,$C5,$00,$05
	dc.b $8A,$02,$60,$22,$61,$00,$F4,$02,$4A,$2E,$02,$38,$67,$18,$4A,$82
	dc.b $66,$06,$4A,$2E,$01,$20,$66,$0E,$6F,$16,$B4,$BC,$00,$00,$00,$20
	dc.b $67,$04,$6E,$0C,$8A,$42,$B2,$3C,$00,$7D,$66,$96,$12,$1C,$4E,$75
	dc.b $61,$00,$55,$D0,$60,$F0,$50,$EE,$02,$3B,$B2,$3C,$00,$23,$67,$22
	dc.b $61,$00,$F4,$5A,$2F,$0C,$B2,$3C,$00,$2C,$66,$00,$61,$52,$12,$1C
	dc.b $D4,$02,$52,$02,$42,$67,$1A,$C2,$1A,$C6,$61,$00,$F3,$C0,$00,$FD
	dc.b $60,$20,$3A,$C6,$12,$1C,$61,$00,$EA,$8A,$2F,$0C,$3F,$02,$61,$00
	dc.b $F7,$B4,$B2,$3C,$00,$2C,$66,$00,$61,$26,$12,$1C,$61,$00,$F3,$9E
	dc.b $00,$7D,$34,$1F,$24,$5F,$02,$45,$00,$38,$66,$06,$70,$03,$60,$00
	dc.b $0C,$9E,$B4,$7C,$00,$08,$65,$16,$4A,$2E,$01,$1E,$67,$10,$28,$4A
	dc.b $6A,$06,$70,$6A,$60,$00,$61,$1C,$70,$09,$61,$00,$62,$1C,$70,$01
	dc.b $60,$00,$0C,$7C,$50,$EE,$02,$3B,$B2,$3C,$00,$23,$67,$22,$61,$00
	dc.b $F3,$DC,$2F,$0C,$B2,$3C,$00,$2C,$66,$00,$60,$D4,$12,$1C,$D4,$02
	dc.b $52,$02,$42,$67,$1A,$C2,$1A,$C6,$61,$00,$F3,$42,$00,$3D,$60,$A2
	dc.b $3A,$C6,$12,$1C,$61,$00,$EA,$0C,$2F,$0C,$3F,$02,$61,$00,$F7,$36
	dc.b $B2,$3C,$00,$2C,$66,$00,$60,$A8,$12,$1C,$61,$00,$F3,$20,$00,$3D
	dc.b $60,$80,$0C,$2E,$00,$14,$01,$21,$66,$00,$0D,$64,$4A,$2E,$02,$39
	dc.b $67,$04,$61,$00,$60,$72,$B2,$3C,$00,$23,$66,$00,$60,$8A,$12,$1C
	dc.b $3A,$C6,$61,$00,$E9,$CE,$61,$00,$F6,$FC,$B2,$3C,$00,$2C,$66,$00
	dc.b $60,$6E,$12,$1C,$61,$00,$F2,$E6,$00,$64,$4E,$75,$0C,$2E,$00,$14
	dc.b $01,$21,$6D,$00,$0D,$2A,$0C,$2E,$00,$20,$01,$21,$67,$00,$0D,$20
	dc.b $70,$00,$10,$2E,$02,$39,$D0,$40,$8C,$7B,$00,$36,$61,$00,$F3,$3E
	dc.b $7A,$00,$1A,$02,$B2,$3C,$00,$2C,$66,$00,$60,$34,$12,$1C,$61,$00
	dc.b $F3,$2C,$02,$42,$00,$FF,$ED,$4A,$8A,$42,$B2,$3C,$00,$2C,$66,$00
	dc.b $60,$1E,$12,$1C,$3F,$05,$61,$00,$F2,$9A,$00,$3C,$3A,$DF,$4E,$75
	dc.b $04,$00,$02,$00,$04,$00,$06,$00,$70,$56,$60,$00,$60,$22,$0C,$2E
	dc.b $00,$14,$01,$21,$6D,$00,$0C,$C8,$0C,$2E,$00,$20,$01,$21,$67,$00
	dc.b $0C,$BE,$70,$00,$10,$2E,$02,$39,$B0,$3C,$00,$01,$67,$00,$5F,$C8
	dc.b $B0,$3C,$00,$03,$66,$04,$08,$C6,$00,$09,$3A,$C6,$7A,$00,$7C,$00
	dc.b $61,$00,$F2,$CA,$8A,$02,$B2,$3C,$00,$3A,$66,$BC,$12,$1C,$61,$00
	dc.b $F2,$BC,$8C,$02,$B2,$3C,$00,$2C,$66,$00,$5F,$B4,$12,$1C,$61,$30
	dc.b $8A,$42,$B2,$3C,$00,$3A,$66,$A0,$12,$1C,$61,$00,$00,$24,$8C,$42
	dc.b $B2,$3C,$00,$2C,$66,$00,$5F,$98,$12,$1C,$61,$20,$8A,$42,$B2,$3C
	dc.b $00,$3A,$66,$84,$12,$1C,$61,$14,$8C,$42,$3A,$C5,$3A,$C6,$4E,$75
	dc.b $61,$00,$F2,$7A,$02,$42,$00,$FF,$ED,$4A,$4E,$75,$B2,$3C,$00,$28
	dc.b $66,$20,$12,$1C,$61,$00,$F2,$84,$66,$18,$02,$42,$00,$FF,$4A,$00
	dc.b $67,$04,$00,$02,$00,$08,$E8,$5A,$B2,$3C,$00,$29,$66,$04,$12,$1C
	dc.b $4E,$75,$60,$00,$5F,$1A,$7E,$04,$B2,$3C,$00,$23,$66,$12,$12,$1C
	dc.b $61,$00,$F1,$A6,$2E,$02,$B2,$3C,$00,$2C,$66,$00,$5F,$32,$12,$1C
	dc.b $B2,$3C,$00,$09,$67,$5C,$B2,$3C,$00,$20,$67,$56,$B2,$3C,$00,$0A
	dc.b $67,$50,$41,$EE,$04,$6E,$61,$00,$51,$6C,$66,$00,$5E,$E2,$7C,$02
	dc.b $B2,$3C,$00,$2E,$66,$20,$12,$1C,$48,$81,$12,$36,$10,$7E,$B2,$3C
	dc.b $00,$42,$67,$14,$B2,$3C,$00,$57,$67,$0E,$7C,$04,$B2,$3C,$00,$4C
	dc.b $66,$00,$5E,$D4,$60,$02,$53,$8C,$12,$1C,$28,$07,$DE,$86,$48,$E7
	dc.b $41,$00,$61,$10,$4C,$DF,$00,$82,$B2,$3C,$00,$2C,$66,$04,$12,$1C
	dc.b $60,$B0,$4E,$75,$4A,$2E,$02,$38,$66,$2A,$61,$00,$E6,$2E,$67,$00
	dc.b $5E,$92,$76,$02,$10,$28,$00,$06,$B0,$2E,$01,$16,$67,$08,$45,$EE
	dc.b $01,$6A,$60,$00,$E6,$FE,$45,$EE,$01,$5A,$4A,$92,$66,$00,$E7,$8A
	dc.b $60,$00,$5E,$7C,$61,$00,$E6,$04,$66,$00,$5E,$6C,$08,$E9,$00,$06
	dc.b $00,$0C,$66,$00,$5E,$5E,$0C,$29,$00,$02,$00,$0D,$66,$00,$5E,$54
	dc.b $B8,$A9,$00,$08,$66,$00,$5E,$54,$4E,$75,$0C,$2E,$00,$14,$01,$21
	dc.b $6D,$00,$01,$58,$10,$2E,$02,$39,$67,$12,$B0,$3C,$00,$02,$67,$0C
	dc.b $B0,$3C,$00,$03,$66,$00,$5E,$40,$08,$86,$00,$07,$61,$00,$F0,$D4
	dc.b $00,$FD,$B2,$3C,$00,$2C,$66,$00,$5E,$46,$12,$1C,$61,$00,$F1,$3E
	dc.b $20,$6E,$02,$4C,$D4,$02,$85,$10,$4E,$75,$0C,$2E,$00,$14,$01,$21
	dc.b $6D,$00,$0A,$FC,$3A,$06,$08,$86,$00,$0B,$70,$00,$10,$2E,$02,$39
	dc.b $D0,$40,$8C,$7B,$00,$2A,$3A,$C6,$02,$45,$08,$00,$3A,$C5,$61,$00
	dc.b $F0,$8C,$00,$64,$B2,$3C,$00,$2C,$66,$00,$5E,$04,$12,$1C,$61,$00
	dc.b $23,$D8,$E9,$02,$20,$6E,$02,$4C,$85,$28,$00,$02,$4E,$75,$02,$00
	dc.b $00,$00,$02,$00,$04,$00,$7A,$00,$60,$04,$3A,$3C,$08,$00,$0C,$2E
	dc.b $00,$14,$01,$21,$6D,$00,$0A,$A8,$61,$00,$FC,$C2,$3A,$C6,$3A,$C5
	dc.b $61,$00,$F0,$4A,$00,$FD,$B2,$3C,$00,$2C,$66,$00,$5D,$C2,$12,$1C
	dc.b $61,$00,$F0,$BA,$20,$6E,$02,$4C,$B2,$3C,$00,$3A,$66,$16,$12,$1C
	dc.b $85,$28,$00,$03,$61,$00,$F0,$A6,$20,$6E,$02,$4C,$E9,$0A,$85,$28
	dc.b $00,$02,$4E,$75,$70,$25,$60,$00,$5D,$BA,$0C,$2E,$00,$14,$01,$21
	dc.b $6D,$78,$10,$2E,$02,$39,$67,$72,$B0,$3C,$00,$02,$67,$6C,$B0,$3C
	dc.b $00,$03,$66,$00,$5D,$62,$08,$06,$00,$08,$56,$C5,$48,$85,$02,$45
	dc.b $08,$00,$08,$06,$00,$0E,$57,$C6,$48,$86,$02,$46,$00,$40,$00,$46
	dc.b $4C,$00,$3A,$C6,$3A,$C5,$61,$00,$EF,$D4,$00,$FD,$B2,$3C,$00,$2C
	dc.b $66,$00,$5D,$4C,$12,$1C,$61,$00,$F0,$44,$20,$6E,$02,$4C,$B2,$3C
	dc.b $00,$3A,$67,$0C,$85,$28,$00,$03,$E9,$0A,$85,$28,$00,$02,$4E,$75
	dc.b $12,$1C,$85,$28,$00,$03,$61,$00,$F0,$24,$20,$6E,$02,$4C,$E9,$0A
	dc.b $08,$C2,$00,$02,$85,$28,$00,$02,$4E,$75,$61,$00,$EF,$96,$00,$FD
	dc.b $B2,$3C,$00,$2C,$66,$00,$5D,$08,$12,$1C,$61,$00,$F0,$00,$20,$6E
	dc.b $02,$4C,$D4,$02,$85,$10,$70,$02,$60,$00,$08,$84,$61,$00,$27,$A8
	dc.b $3A,$C6,$61,$00,$F0,$FA,$B2,$3C,$00,$2C,$66,$00,$5C,$E2,$12,$1C
	dc.b $3F,$05,$61,$00,$F0,$F6,$38,$1F,$20,$6E,$02,$4C,$30,$05,$02,$00
	dc.b $00,$78,$67,$4A,$B0,$3C,$00,$08,$67,$54,$B8,$3C,$00,$3C,$67,$74
	dc.b $10,$04,$02,$00,$00,$78,$B0,$3C,$00,$18,$66,$2E,$10,$05,$02,$00
	dc.b $00,$78,$B0,$3C,$00,$18,$66,$22,$3C,$3C,$B1,$08,$61,$00,$27,$58
	dc.b $10,$04,$02,$00,$00,$07,$8C,$00,$10,$05,$02,$40,$00,$07,$EE,$58
	dc.b $8C,$40,$20,$6E,$02,$4C,$30,$86,$4E,$75,$60,$00,$EF,$62,$DA,$05
	dc.b $8B,$10,$3A,$04,$8B,$50,$30,$3C,$00,$FF,$60,$00,$EF,$1A,$02,$05
	dc.b $00,$07,$DA,$05,$0C,$2E,$00,$03,$02,$39,$66,$02,$52,$05,$8B,$10
	dc.b $3A,$04,$00,$44,$00,$C0,$89,$50,$30,$3C,$00,$FF,$61,$00,$EE,$F8
	dc.b $60,$00,$F7,$10,$3C,$3C,$0C,$00,$61,$00,$26,$FC,$8C,$45,$30,$86
	dc.b $70,$3D,$60,$00,$EE,$E2,$61,$00,$26,$EE,$61,$16,$8C,$05,$B2,$3C
	dc.b $00,$2C,$66,$00,$5C,$2A,$12,$1C,$61,$08,$EE,$5D,$8C,$45,$3A,$C6
	dc.b $4E,$75,$61,$00,$F0,$36,$10,$05,$02,$00,$00,$78,$B0,$3C,$00,$18
	dc.b $66,$00,$EE,$EC,$02,$45,$00,$07,$4E,$75,$61,$00,$42,$72,$B2,$3C
	dc.b $00,$2C,$66,$00,$5B,$FA,$12,$1C,$2A,$02,$61,$00,$42,$62,$20,$02
	dc.b $67,$18,$6B,$3C,$2F,$02,$24,$2E,$02,$3C,$20,$17,$61,$00,$E9,$30
	dc.b $24,$1F,$4A,$80,$67,$04,$90,$82,$44,$80,$D0,$85,$28,$00,$67,$10
	dc.b $B0,$BC,$00,$00,$00,$80,$64,$18,$1A,$FC,$00,$00,$53,$00,$66,$F8
	dc.b $D8,$AE,$02,$3C,$41,$EE,$03,$E8,$4A,$90,$66,$00,$E3,$D4,$4E,$75
	dc.b $70,$1D,$60,$00,$5B,$CE,$43,$EC,$FF,$FF,$B2,$3C,$00,$0A,$67,$1A
	dc.b $12,$1C,$B2,$3C,$00,$0A,$66,$F8,$24,$0C,$94,$89,$53,$42,$4A,$2E
	dc.b $02,$38,$67,$06,$61,$00,$6E,$12,$72,$0A,$4E,$75,$61,$00,$EE,$7E
	dc.b $8C,$02,$B2,$3C,$00,$2C,$66,$00,$5B,$76,$12,$1C,$61,$00,$FE,$78
	dc.b $60,$00,$F7,$BA,$3F,$01,$10,$2E,$02,$39,$67,$06,$B0,$3C,$00,$01
	dc.b $67,$10,$61,$00,$E3,$5C,$10,$2E,$02,$39,$66,$02,$70,$02,$32,$1F
	dc.b $4E,$75,$41,$EE,$03,$E8,$4A,$90,$67,$08,$28,$2E,$02,$3C,$61,$00
	dc.b $E3,$60,$10,$2E,$02,$39,$60,$E6,$61,$CA,$61,$00,$41,$A2,$B2,$3C
	dc.b $00,$2C,$67,$06,$2F,$02,$74,$00,$60,$08,$12,$1C,$2F,$02,$61,$00
	dc.b $41,$8E,$76,$00,$41,$FA,$01,$8E,$22,$02,$16,$2E,$02,$39,$16,$30
	dc.b $30,$00,$28,$1F,$42,$AE,$01,$82,$4A,$2E,$01,$03,$67,$06,$4A,$2E
	dc.b $02,$38,$66,$16,$E7,$AC,$6A,$00,$00,$08,$70,$54,$60,$00,$5B,$10
	dc.b $2D,$44,$01,$8E,$12,$2C,$FF,$FF,$4E,$75,$1D,$7C,$00,$FF,$08,$3B
	dc.b $2D,$6E,$02,$3C,$08,$3C,$61,$00,$6D,$A2,$67,$D8,$42,$AE,$01,$8E
	dc.b $53,$84,$65,$E0,$48,$7A,$FF,$DE,$53,$03,$65,$2A,$67,$14,$2A,$C1
	dc.b $7A,$04,$61,$36,$51,$CC,$FF,$F8,$04,$84,$00,$01,$00,$00,$64,$EE
	dc.b $4E,$75,$3A,$C1,$7A,$02,$61,$22,$51,$CC,$FF,$F8,$04,$84,$00,$01
	dc.b $00,$00,$64,$EE,$4E,$75,$1A,$C1,$7A,$01,$61,$0E,$51,$CC,$FF,$F8
	dc.b $04,$84,$00,$01,$00,$00,$64,$EE,$4E,$75,$2F,$01,$22,$05,$24,$2E
	dc.b $02,$3C,$D4,$AE,$01,$8E,$61,$00,$6D,$22,$DB,$AE,$01,$8E,$22,$1F
	dc.b $2A,$6E,$02,$4C,$4E,$75,$61,$00,$FE,$FC,$B0,$3C,$00,$01,$67,$00
	dc.b $00,$5E,$B0,$3C,$00,$03,$67,$1A,$B0,$3C,$00,$02,$67,$08,$61,$00
	dc.b $31,$02,$61,$1A,$60,$F8,$61,$00,$E3,$9A,$61,$00,$F0,$B0,$61,$0E
	dc.b $60,$F4,$61,$00,$E3,$8E,$61,$00,$F0,$84,$61,$02,$60,$F4,$B2,$3C
	dc.b $00,$2C,$66,$26,$12,$1C,$B2,$3C,$00,$09,$67,$08,$B2,$3C,$00,$20
	dc.b $67,$02,$4E,$75,$70,$0B,$61,$00,$5B,$40,$12,$1C,$B2,$3C,$00,$09
	dc.b $67,$F8,$B2,$3C,$00,$20,$67,$F2,$4E,$75,$58,$8F,$4E,$75,$B2,$3C
	dc.b $00,$27,$67,$24,$B2,$3C,$00,$22,$67,$1E,$61,$00,$E3,$46,$4A,$2E
	dc.b $02,$38,$67,$08,$4A,$43,$6B,$0A,$61,$00,$4E,$0E,$1A,$C2,$61,$AE
	dc.b $60,$DC,$61,$00,$6E,$CC,$60,$F6,$16,$01,$48,$E7,$00,$0C,$12,$1C
	dc.b $B2,$3C,$00,$0A,$67,$36,$B2,$03,$66,$06,$12,$1C,$B6,$01,$66,$04
	dc.b $1A,$C1,$60,$EA,$B2,$3C,$00,$0A,$67,$1A,$B2,$3C,$00,$09,$67,$14
	dc.b $B2,$3C,$00,$20,$67,$0E,$B2,$3C,$00,$2C,$67,$08,$4C,$DF,$30,$00
	dc.b $12,$03,$60,$A6,$50,$8F,$61,$00,$FF,$66,$60,$92,$50,$8F,$70,$37
	dc.b $60,$00,$59,$B0,$01,$00,$01,$02,$61,$00,$FE,$1A,$48,$80,$1C,$3B
	dc.b $00,$F4,$61,$00,$3F,$EA,$4A,$82,$67,$0A,$28,$02,$16,$06,$72,$00
	dc.b $60,$00,$FE,$62,$4E,$75,$50,$EE,$01,$15,$72,$0A,$4E,$75,$41,$EE
	dc.b $03,$E8,$4A,$90,$67,$02,$4E,$75,$70,$29,$60,$00,$59,$72,$61,$EE
	dc.b $4A,$2E,$02,$38,$66,$30,$2F,$08,$61,$00,$3F,$94,$20,$5F,$48,$E7
	dc.b $30,$00,$61,$00,$E0,$A6,$4C,$DF,$00,$30,$67,$00,$59,$06,$16,$05
	dc.b $48,$7A,$00,$44,$45,$EE,$01,$6A,$55,$05,$67,$00,$E1,$76,$45,$EE
	dc.b $01,$62,$60,$00,$E1,$6E,$61,$00,$E0,$82,$66,$00,$58,$FE,$08,$29
	dc.b $00,$06,$00,$0C,$66,$00,$58,$DC,$2F,$09,$61,$00,$EB,$48,$22,$5F
	dc.b $B4,$A9,$00,$08,$66,$00,$58,$D4,$B6,$29,$00,$0D,$66,$00,$58,$C4
	dc.b $08,$E9,$00,$06,$00,$0C,$12,$2C,$FF,$FF,$1D,$7C,$00,$3D,$08,$3B
	dc.b $2D,$42,$08,$3C,$4E,$75,$70,$2D,$60,$00,$58,$F8,$70,$2E,$60,$00
	dc.b $58,$F2,$61,$00,$FF,$6A,$61,$00,$EB,$E2,$66,$F0,$48,$42,$34,$00
	dc.b $48,$42,$02,$82,$00,$FF,$00,$FF,$24,$6E,$01,$6A,$41,$EE,$03,$E8
	dc.b $48,$E7,$20,$1C,$4A,$2E,$02,$38,$66,$16,$61,$00,$DF,$C8,$4C,$DF
	dc.b $38,$10,$67,$00,$58,$6E,$76,$04,$61,$00,$E0,$EC,$72,$0A,$4E,$75
	...
	dc.b $6D,$00,$04,$AC,$61,$00,$F6,$C6,$61,$00,$EA,$D2,$8C,$02,$3A,$C6
	dc.b $4E,$75,$10,$2E,$02,$39,$67,$F0,$B0,$3C,$00,$02,$67,$EA,$B0,$3C
	dc.b $00,$03,$66,$00,$57,$A2,$08,$C6,$00,$06,$60,$DC,$72,$0A,$70,$38
	dc.b $60,$00,$57,$D0,$41,$EE,$0C,$24,$B2,$3C,$00,$0A,$67,$3C,$B2,$3C
	dc.b $00,$09,$67,$36,$B2,$3C,$00,$20,$67,$30,$04,$01,$00,$30,$65,$2C
	dc.b $B2,$3C,$00,$08,$64,$26,$70,$07,$90,$01,$12,$1C,$B2,$3C,$00,$2B
	dc.b $67,$0A,$B2,$3C,$00,$2D,$66,$14,$01,$90,$60,$02,$01,$D0,$12,$1C
	dc.b $B2,$3C,$00,$2C,$66,$04,$12,$1C,$60,$BE,$4E,$75,$70,$4C,$60,$00
	dc.b $57,$82,$61,$00,$3D,$CA,$4A,$82,$67,$00,$DF,$36,$B2,$3C,$00,$09
	dc.b $67,$06,$B2,$3C,$00,$20,$66,$04,$12,$1C,$60,$F0,$61,$00,$DD,$16
	dc.b $41,$FA,$00,$08,$2D,$48,$01,$7A,$72,$0A,$4E,$75,$4A,$2E,$01,$1B
	dc.b $66,$00,$57,$24,$41,$EE,$03,$E8,$76,$00,$61,$00,$4A,$D8,$41,$EE
	dc.b $03,$EE,$42,$2E,$01,$0A,$4E,$B9
	dc.l loc_0_0000AFDE
	...
	dc.b $36,$38,$00,$43,$50,$55,$33,$32,$00,$00,$74,$00,$12,$1C,$B2,$3C
	dc.b $00,$30,$65,$1C,$B2,$3C,$00,$3A,$64,$16,$04,$01,$00,$30,$48,$81
	dc.b $48,$C1,$D4,$82,$20,$02,$D4,$82,$D4,$82,$D4,$80,$D4,$81,$60,$DC
	dc.b $04,$82,$00,$01,$09,$A0,$65,$46,$67,$66,$B4,$BC,$00,$00,$03,$84
	dc.b $6E,$3C,$B4,$7C,$00,$08,$67,$58,$B4,$7C,$00,$0A,$67,$52,$B4,$7C
	dc.b $00,$14,$67,$4C,$B4,$7C,$00,$1E,$67,$46,$B4,$7C,$01,$4C,$67,$20
	dc.b $B4,$7C,$00,$28,$67,$34,$B4,$7C,$00,$3C,$67,$2E,$B4,$7C,$03,$71
	dc.b $67,$20,$B4,$7C,$03,$72,$67,$12,$B4,$7C,$03,$53,$67,$06,$4E,$75
	dc.b $74,$20,$60,$1C,$50,$EE,$01,$23,$60,$1E,$1D,$7C,$00,$52,$01,$22
	dc.b $60,$16,$1D,$7C,$00,$51,$01,$22,$60,$0E,$50,$EE,$01,$22,$60,$04
	dc.b $51,$EE,$01,$22,$1D,$42,$01,$21,$B2,$3C,$00,$2F,$67,$00,$FF,$5C
	dc.b $70,$00,$4E,$75,$61,$00,$1D,$00,$B2,$3C,$00,$23,$66,$00,$52,$48
	dc.b $12,$1C,$61,$00,$E4,$A4,$61,$16,$EE,$5A,$8C,$42,$B2,$3C,$00,$2C
	dc.b $66,$00,$52,$2C,$12,$1C,$61,$00,$E4,$AA,$00,$3F,$4E,$75,$4A,$2E
	dc.b $02,$38,$67,$10,$4A,$82,$67,$0E,$B4,$BC,$00,$00,$00,$08,$62,$0C
	dc.b $66,$02,$74,$00,$4E,$75,$4A,$2E,$01,$20,$66,$F8,$70,$1D,$60,$00
	dc.b $52,$22,$61,$00,$1B,$9E,$34,$2E,$02,$1C,$B4,$7C,$00,$03,$67,$20
	dc.b $08,$02,$00,$01,$66,$22,$B4,$7C,$00,$05,$67,$1C,$4A,$42,$66,$12
	dc.b $61,$00,$47,$54,$20,$4C,$12,$2C,$FF,$FF,$61,$00,$46,$58,$72,$0A
	dc.b $4E,$75,$70,$06,$60,$00,$52,$F2,$45,$EE,$01,$AE,$61,$00,$1B,$0C
	dc.b $51,$EE,$01,$13,$4E,$75,$12,$1C,$61,$00,$DB,$08,$4A,$04,$66,$00
	dc.b $00,$82,$B6,$3C,$00,$02,$66,$7A,$B2,$3C,$00,$2C,$66,$74,$28,$02
	dc.b $2F,$0C,$12,$1C,$61,$00,$E4,$B4,$66,$62,$4A,$00,$66,$30,$20,$04
	dc.b $48,$80,$48,$C0,$B8,$80,$66,$54,$08,$2E,$00,$03,$01,$0F,$67,$00
	dc.b $00,$4C,$55,$8D,$61,$00,$5A,$E4,$66,$40,$58,$8F,$00,$02,$00,$38
	dc.b $D4,$02,$E1,$4A,$84,$04,$3A,$C2,$70,$0F,$60,$00,$55,$08,$30,$44
	dc.b $B8,$88,$66,$28,$08,$2E,$00,$03,$01,$0E,$67,$00,$00,$20,$55,$8D
	dc.b $61,$00,$5A,$B8,$66,$14,$58,$8F,$D4,$02,$E1,$4A,$00,$42,$30,$7C
	dc.b $3A,$C2,$3A,$C4,$70,$17,$60,$00,$54,$DC,$54,$8D,$28,$5F,$72,$2C
	dc.b $24,$04,$61,$00,$E7,$68,$60,$3A,$30,$00,$10,$00,$30,$00,$20,$00
	dc.b $70,$00,$10,$2E,$02,$39,$D0,$00,$8C,$7B,$00,$EE,$3A,$C6,$B0,$3C
	dc.b $00,$06,$66,$1A,$B2,$3C,$00,$23,$66,$14,$08,$2E,$00,$03,$01,$0F
	dc.b $66,$00,$FF,$44,$08,$2E,$00,$03,$01,$0E,$66,$00,$FF,$3A,$61,$00
	dc.b $E4,$FE,$B2,$3C,$00,$2C,$66,$00,$50,$E6,$12,$1C,$08,$05,$00,$06
	dc.b $66,$00,$00,$AC,$20,$6E,$02,$4C,$8B,$50,$61,$00,$E4,$EE,$20,$6E
	dc.b $02,$4C,$08,$05,$00,$06,$66,$26,$34,$05,$30,$05,$02,$00,$00,$07
	dc.b $D0,$00,$81,$10,$02,$45,$00,$38,$DA,$45,$DA,$45,$DA,$45,$8B,$50
	dc.b $02,$42,$00,$3F,$B4,$7C,$00,$3A,$64,$00,$E3,$84,$4E,$75,$38,$10
	dc.b $E2,$0D,$65,$2C,$E2,$0D,$65,$50,$4A,$2E,$01,$25,$67,$06,$70,$65
	dc.b $61,$00,$50,$B0,$10,$04,$02,$00,$00,$38,$B0,$3C,$00,$08,$66,$00
	dc.b $E3,$5E,$02,$44,$00,$07,$00,$44,$4E,$60,$30,$84,$60,$00,$EF,$5E
	dc.b $3C,$3C,$44,$C0,$0C,$2E,$00,$03,$02,$39,$66,$04,$61,$00,$50,$48
	dc.b $02,$44,$00,$3F,$10,$04,$02,$00,$00,$38,$B0,$3C,$00,$08,$67,$00
	dc.b $E3,$2E,$8C,$44,$30,$86,$4E,$75,$4A,$2E,$01,$25,$67,$06,$70,$65
	dc.b $61,$00,$50,$60,$61,$00,$F3,$40,$3C,$3C,$46,$C0,$60,$D2,$24,$6E
	dc.b $02,$4C,$E2,$0D,$65,$3A,$E2,$0D,$65,$1C,$4A,$2E,$01,$25,$67,$06
	dc.b $70,$65,$61,$00,$50,$3E,$61,$00,$E3,$1E,$3C,$3C,$4E,$68,$8C,$02
	dc.b $34,$86,$60,$00,$EE,$F8,$4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00
	dc.b $50,$22,$34,$BC,$40,$C0,$61,$00,$E2,$74,$00,$3D,$60,$00,$F2,$F8
	dc.b $4A,$2E,$01,$21,$66,$08,$61,$EA,$70,$04,$60,$00,$51,$0C,$34,$BC
	dc.b $42,$C0,$61,$00,$E2,$58,$00,$3D,$0C,$2E,$00,$03,$02,$39,$67,$00
	dc.b $4F,$B6,$4E,$75,$4A,$2E,$01,$21,$67,$00,$FC,$94,$4A,$2E,$01,$25
	dc.b $67,$06,$70,$65,$61,$00,$4F,$DC,$61,$00,$EE,$A2,$61,$00,$E2,$CC
	dc.b $66,$26,$B2,$3C,$00,$2C,$66,$00,$4F,$A6,$12,$1C,$3A,$FC,$4E,$7B
	dc.b $E7,$08,$84,$00,$02,$42,$00,$0F,$E8,$5A,$36,$02,$61,$36,$66,$00
	dc.b $4F,$8A,$84,$43,$3A,$C2,$4E,$75,$61,$2A,$66,$00,$4F,$7E,$B2,$3C
	dc.b $00,$2C,$66,$00,$4F,$7A,$12,$1C,$36,$02,$61,$00,$E2,$8E,$66,$00
	dc.b $4F,$6A,$3A,$C6,$E7,$08,$84,$00,$02,$42,$00,$0F,$E8,$5A,$86,$42
	dc.b $3A,$C3,$4E,$75,$10,$01,$48,$80,$10,$36,$00,$7E,$41,$FA,$00,$B4
	dc.b $74,$00,$14,$18,$67,$00,$00,$A8,$B0,$10,$66,$00,$00,$9A,$48,$E7
	dc.b $A0,$88,$52,$88,$10,$1C,$48,$80,$10,$36,$00,$7E,$B0,$18,$66,$00
	dc.b $00,$82,$53,$02,$66,$EE,$4F,$EF,$00,$10,$14,$18,$E1,$4A,$14,$18
	dc.b $12,$1C,$10,$2E,$01,$21,$67,$1E,$B0,$3C,$00,$28,$67,$3C,$B0,$3C
	dc.b $00,$3C,$67,$1C,$B0,$3C,$00,$20,$67,$06,$B0,$3C,$00,$0A,$66,$3E
	dc.b $B4,$3C,$00,$02,$65,$06,$70,$22,$61,$00,$4F,$18,$70,$00,$4E,$75
	dc.b $B4,$7C,$08,$03,$67,$F0,$B4,$7C,$08,$04,$67,$EA,$B4,$7C,$08,$05
	dc.b $67,$E4,$B4,$7C,$08,$02,$66,$E4,$60,$DC,$B4,$7C,$00,$08,$67,$D6
	dc.b $B4,$7C,$08,$08,$67,$D0,$B4,$7C,$08,$02,$66,$D0,$60,$C8,$B4,$7C
	dc.b $08,$05,$64,$C2,$B4,$7C,$08,$00,$64,$C2,$B4,$7C,$00,$03,$65,$BC
	dc.b $60,$B4,$4C,$DF,$11,$05,$41,$F0,$20,$03,$60,$00,$FF,$56,$70,$FF
	dc.b $4E,$75,$02,$53,$46,$43,$00,$00,$02,$44,$46,$43,$00,$01,$03,$43
	dc.b $41,$43,$52,$00,$02,$02,$55,$53,$50,$08,$00,$02,$56,$42,$52,$08
	dc.b $01,$03,$43,$41,$41,$52,$08,$02,$02,$4D,$53,$50,$08,$03,$02,$49
	dc.b $53,$50,$08,$04,$01,$54,$43,$00,$03,$03,$49,$54,$54,$30,$00,$04
	dc.b $03,$49,$54,$54,$31,$00,$05,$03,$44,$54,$54,$30,$00,$06,$03,$44
	dc.b $54,$54,$31,$00,$07,$04,$4D,$4D,$55,$53,$52,$08,$05,$02,$55,$52
	dc.b $50,$08,$06,$02,$53,$52,$50,$08,$07,$04,$42,$55,$53,$43,$52,$00
	dc.b $08,$02,$50,$43,$52,$08,$08,$00,$10,$2E,$02,$39,$67,$12,$B0,$3C
	dc.b $00,$02,$67,$0C,$B0,$3C,$00,$03,$66,$00,$4D,$FC,$00,$06,$00,$40
	dc.b $61,$72,$66,$00,$00,$4A,$B2,$3C,$00,$2C,$66,$00,$4E,$02,$12,$1C
	dc.b $3A,$C6,$3A,$C4,$61,$00,$E2,$14,$BA,$7C,$00,$40,$64,$00,$E0,$D0
	dc.b $14,$05,$02,$02,$00,$38,$B4,$3C,$00,$20,$66,$1C,$4A,$2E,$02,$38
	dc.b $67,$16,$20,$6E,$02,$4C,$20,$10,$74,$00,$76,$0F,$E3,$48,$E2,$52
	dc.b $51,$CB,$FF,$FA,$31,$42,$00,$02,$70,$34,$60,$00,$E0,$64,$00,$46
	dc.b $04,$00,$3A,$C6,$54,$8D,$61,$00,$E0,$34,$00,$6C,$B2,$3C,$00,$2C
	dc.b $66,$00,$4D,$AC,$12,$1C,$61,$0C,$66,$78,$20,$6E,$02,$4C,$31,$44
	dc.b $00,$02,$4E,$75,$78,$00,$61,$00,$E0,$B2,$67,$48,$41,$EE,$04,$6E
	dc.b $48,$E7,$40,$08,$61,$00,$3F,$DE,$66,$34,$24,$6E,$01,$6A,$48,$E7
	dc.b $50,$1C,$61,$00,$D4,$A0,$4C,$DF,$38,$0A,$66,$22,$0C,$29,$00,$05
	dc.b $00,$0D,$66,$1A,$28,$29,$00,$08,$4A,$2E,$02,$38,$67,$08,$08,$29
	dc.b $00,$06,$00,$0C,$67,$06,$50,$8F,$70,$00,$4E,$75,$70,$FF,$4C,$DF
	dc.b $10,$02,$4E,$75,$E7,$08,$D0,$02,$B2,$3C,$00,$2D,$67,$1A,$01,$C4
	dc.b $B2,$3C,$00,$2F,$67,$04,$70,$00,$4E,$75,$12,$1C,$61,$00,$E0,$4C
	dc.b $67,$E2,$70,$39,$60,$00,$4D,$48,$12,$1C,$B2,$3C,$00,$38,$64,$16
	dc.b $B2,$3C,$00,$30,$65,$10,$16,$00,$02,$00,$00,$08,$04,$01,$00,$30
	dc.b $D0,$01,$12,$1C,$60,$0E,$3F,$00,$61,$00,$E0,$20,$66,$D4,$E7,$08
	dc.b $D0,$02,$36,$1F,$B0,$03,$65,$CA,$52,$00,$07,$C4,$52,$03,$B6,$00
	dc.b $66,$F8,$60,$AC,$61,$00,$DF,$6C,$00,$FF,$48,$E7,$18,$00,$B2,$3C
	dc.b $00,$2C,$66,$00,$4C,$DA,$12,$1C,$61,$00,$DF,$DC,$4C,$DF,$00,$18
	dc.b $D4,$02,$20,$6E,$02,$4C,$85,$10,$10,$2E,$02,$39,$67,$0E,$B0,$3C
	dc.b $00,$03,$67,$0E,$B0,$3C,$00,$02,$66,$00,$4C,$9C,$00,$10,$00,$10
	dc.b $4E,$75,$08,$2E,$00,$03,$01,$0E,$67,$42,$4A,$04,$66,$3E,$B6,$3C
	dc.b $00,$02,$66,$38,$36,$10,$02,$43,$00,$3F,$B6,$3C,$00,$3C,$66,$2C
	dc.b $20,$28,$00,$02,$32,$40,$B0,$89,$66,$22,$48,$E7,$80,$80,$24,$00
	dc.b $55,$4D,$61,$00,$55,$E6,$4C,$DF,$01,$01,$66,$0E,$00,$10,$00,$10
	dc.b $31,$40,$00,$02,$70,$17,$60,$00,$50,$0C,$54,$4D,$4E,$75,$10,$2E
	dc.b $02,$39,$B0,$3C,$00,$01,$67,$00,$4C,$3E,$B0,$3C,$00,$03,$66,$04
	dc.b $00,$06,$00,$40,$61,$00,$DF,$64,$66,$24,$4A,$00,$66,$00,$00,$3A
	dc.b $00,$06,$00,$80,$02,$42,$00,$07,$EE,$5A,$8C,$42,$B2,$3C,$00,$2C
	dc.b $66,$00,$4C,$2C,$12,$1C,$61,$26,$3A,$C6,$3A,$C3,$4E,$75,$61,$1E
	dc.b $B2,$3C,$00,$2C,$66,$00,$4C,$18,$12,$1C,$61,$00,$DF,$10,$02,$42
	dc.b $00,$07,$EE,$5A,$8C,$42,$60,$E0,$70,$2F,$60,$00,$4C,$26,$74,$00
	dc.b $0C,$2E,$00,$14,$01,$21,$6D,$3A,$B2,$3C,$00,$28,$66,$3A,$12,$1C
	dc.b $36,$02,$61,$00,$DE,$F2,$66,$16,$8C,$02,$B2,$3C,$00,$2C,$66,$40
	dc.b $12,$1C,$61,$00,$DE,$20,$61,$00,$40,$2A,$36,$02,$60,$32,$61,$00
	dc.b $DE,$14,$61,$00,$40,$1E,$36,$02,$B2,$3C,$00,$2C,$66,$BA,$60,$00
	dc.b $00,$16,$B2,$3C,$00,$28,$67,$0E,$61,$00,$DD,$FA,$61,$00,$40,$04
	dc.b $B2,$3C,$00,$28,$66,$A2,$12,$1C,$36,$02,$61,$00,$DE,$AA,$8C,$02
	dc.b $B2,$3C,$00,$29,$66,$92,$12,$1C,$4E,$75,$B2,$3C,$00,$23,$66,$00
	dc.b $4B,$96,$12,$1C,$61,$00,$D4,$DC,$4A,$2E,$02,$38,$67,$2E,$61,$00
	dc.b $3F,$F4,$4A,$43,$6B,$42,$10,$02,$48,$80,$48,$C0,$B4,$80,$67,$1C
	dc.b $B4,$BC,$00,$00,$01,$00,$65,$06,$61,$00,$4B,$58,$60,$0E,$0C,$2E
	dc.b $00,$03,$02,$39,$67,$06,$70,$01,$61,$00,$4C,$7E,$1C,$02,$B2,$3C
	dc.b $00,$2C,$66,$00,$4B,$4A,$12,$1C,$61,$00,$DE,$42,$D4,$02,$70,$70
	dc.b $80,$02,$1A,$C0,$1A,$C6,$4E,$75,$2F,$02,$B2,$3C,$00,$2C,$66,$00
	dc.b $4B,$2E,$12,$1C,$61,$00,$DE,$26,$D4,$02,$70,$70,$80,$02,$1A,$C0
	dc.b $24,$1F,$60,$00,$60,$0C,$0C,$2E,$00,$0A,$01,$21,$6D,$00,$F7,$E0
	dc.b $4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$4B,$28,$61,$00,$15,$B8
	dc.b $3A,$C6,$61,$00,$DE,$16,$66,$18,$76,$01,$61,$3C,$3A,$C3,$B2,$3C
	dc.b $00,$2C,$66,$00,$4A,$EA,$12,$1C,$61,$00,$DD,$62,$00,$3C,$4E,$75
	dc.b $54,$8D,$61,$00,$DD,$58,$00,$3C,$B2,$3C,$00,$2C,$66,$00,$4A,$D0
	dc.b $12,$1C,$61,$00,$DD,$E6,$66,$00,$F1,$F4,$76,$00,$61,$0A,$20,$6E
	dc.b $02,$4C,$31,$43,$00,$02,$4E,$75,$D4,$02,$4A,$00,$56,$C0,$02,$00
	dc.b $00,$10,$86,$00,$86,$02,$EA,$5B,$4E,$75,$61,$00,$E9,$B2,$61,$00
	dc.b $DD,$22,$00,$3D,$4E,$75,$B2,$3C,$00,$09,$67,$06,$B2,$3C,$00,$20
	dc.b $66,$04,$12,$1C,$60,$F0,$74,$00,$B2,$3C,$00,$0A,$67,$10,$B2,$3C
	dc.b $00,$2A,$67,$0A,$B2,$3C,$00,$3B,$67,$04,$61,$00,$30,$E2,$2F,$02
	dc.b $61,$00,$3F,$D6,$24,$1F,$43,$EE,$02,$56,$2D,$49,$01,$42,$23,$42
	dc.b $00,$08,$42,$29,$00,$0E,$2D,$42,$02,$3C,$41,$EE,$05,$A8,$2D,$48
	dc.b $02,$4C,$1D,$7C,$00,$02,$01,$08,$50,$EE,$01,$1B,$12,$2C,$FF,$FF
loc_0_00003A24:
	rts
...
loc_0_00004398:
	...
	dc.b $66,$08,$61,$00,$ED,$5C,$66,$82,$4E,$75,$61,$BE,$57,$EE,$01,$06
	dc.b $4E,$75,$61,$B6,$57,$EE,$00,$FF,$4E,$75,$61,$AE,$57,$EE,$01,$05
	dc.b $4E,$75,$61,$A6,$57,$EE,$01,$04,$4E,$75,$61,$9E,$57,$EE,$01,$19
	dc.b $4E,$75,$61,$96,$57,$EE,$01,$1D,$4E,$75,$61,$8E,$57,$EE,$01,$1F
	dc.b $4E,$75,$74,$5F,$61,$84,$67,$02,$74,$2E,$1D,$42,$01,$16,$4E,$75
	dc.b $61,$00,$00,$FA,$66,$16,$B4,$7C,$00,$08,$65,$00,$FF,$2E,$B4,$7C
	dc.b $00,$80,$64,$00,$FF,$26,$52,$42,$3D,$42,$02,$1E,$B2,$3C,$00,$2B
	dc.b $67,$08,$B2,$3C,$00,$2D,$66,$08,$4A,$01,$56,$EE,$00,$FE,$12,$1C
	dc.b $4E,$75,$4A,$AE,$02,$24,$66,$00,$FF,$3C,$10,$01,$12,$1C,$4A,$2E
	dc.b $02,$38,$66,$60,$B0,$3C,$00,$2B,$67,$38,$B0,$3C,$00,$2D,$67,$2E
	dc.b $04,$00,$00,$30,$65,$00,$FE,$E4,$48,$80,$67,$20,$53,$40,$B0,$7C
	dc.b $00,$07,$64,$00,$FE,$D6,$01,$3C,$00,$6C,$67,$00,$FE,$CE,$B0,$3C
	dc.b $00,$06,$66,$02,$70,$02,$3D,$40,$02,$1C,$60,$0A,$60,$08,$70,$03
	dc.b $60,$F4,$70,$02,$60,$F0,$22,$6E,$01,$42,$20,$6E,$01,$3E,$42,$AE
	dc.b $01,$96,$4A,$2E,$02,$38,$66,$04,$42,$AE,$01,$A6,$61,$00,$34,$AA
	dc.b $12,$2C,$FF,$FF,$4E,$75,$43,$EE,$01,$0E,$48,$81,$12,$36,$10,$7E
	dc.b $B2,$3C,$00,$57,$66,$06,$43,$EE,$01,$10,$12,$1C,$B2,$3C,$00,$2D
	dc.b $67,$2E,$B2,$3C,$00,$2B,$67,$2C,$61,$00,$00,$32,$53,$42,$6B,$00
	dc.b $FE,$6A,$B4,$7C,$00,$0B,$62,$00,$FE,$62,$61,$00,$FE,$9E,$67,$08
	dc.b $30,$11,$05,$80,$32,$80,$4E,$75,$30,$11,$05,$C0,$32,$80,$4E,$75
	dc.b $42,$51,$60,$04,$32,$BC,$FF,$FF,$12,$1C,$4E,$75,$B2,$3C,$00,$30
	dc.b $65,$2E,$B2,$3C,$00,$39,$62,$28,$74,$00,$04,$01,$00,$30,$14,$01
	dc.b $12,$1C,$B2,$3C,$00,$30,$65,$16,$B2,$3C,$00,$3A,$64,$10,$C4,$FC
	dc.b $00,$0A,$04,$01,$00,$30,$02,$41,$00,$0F,$D4,$41,$60,$E2,$70,$00
	dc.b $4E,$75
loc_0_00004590:
	tst.b app_0954(a6)
...
loc_0_00004E62:
	...
	dc.b $49,$44,$00,$FF,$52,$4F,$55,$4E,$44,$00,$4E,$50,$4D,$5A,$00,$50
	dc.b $52,$45,$43,$00,$58,$44,$53,$00,$61,$00,$D2,$80,$16,$2E,$02,$39
	dc.b $66,$06,$1D,$7C,$00,$07,$02,$39,$B6,$3C,$00,$04,$65,$00,$D2,$7E
	dc.b $4A,$2E,$02,$38,$66,$52,$2F,$08,$61,$00,$06,$FA,$20,$5F,$66,$00
	dc.b $2B,$DA,$48,$E7,$30,$00,$61,$00,$B3,$1E,$4C,$DF,$00,$0C,$67,$00
	dc.b $2B,$7E,$45,$EE,$01,$6A,$2F,$02,$16,$2E,$02,$39,$06,$03,$00,$0B
	dc.b $61,$00,$B3,$EC,$24,$5F,$23,$52,$00,$08,$13,$6A,$00,$04,$00,$0E
	dc.b $13,$6A,$00,$05,$00,$0F,$23,$6A,$00,$06,$00,$10,$33,$6A,$00,$0A
	dc.b $00,$14,$12,$2C,$FF,$FF,$4E,$75,$61,$00,$B2,$DC,$66,$00,$2B,$58
	dc.b $08,$29,$00,$06,$00,$0C,$66,$00,$2B,$36,$16,$2E,$02,$39,$2F,$09
	dc.b $61,$00,$06,$92,$22,$5F,$66,$00,$2B,$72,$20,$42,$20,$29,$00,$08
	dc.b $B0,$90,$66,$3C,$10,$29,$00,$0E,$B0,$28,$00,$04,$66,$32,$10,$29
	dc.b $00,$0F,$B0,$28,$00,$05,$66,$28,$20,$29,$00,$10,$B0,$A8,$00,$06
	dc.b $66,$1E,$30,$29,$00,$14,$B0,$68,$00,$0A,$66,$14,$B6,$29,$00,$0D
	dc.b $66,$00,$2A,$EC,$08,$E9,$00,$06,$00,$0C,$12,$2C,$FF,$FF,$4E,$75
	dc.b $60,$00,$2A,$E4,$8C,$6E,$01,$30,$60,$00,$08,$64,$3A,$06,$3C,$3C
	dc.b $F0,$48,$8C,$6E,$01,$30,$48,$45,$3A,$06,$48,$45,$60,$00,$08,$98
	dc.b $3C,$3C,$F0,$00,$8C,$6E,$01,$30,$3A,$C6,$61,$00,$05,$9C,$66,$20
	dc.b $B2,$3C,$00,$2C,$66,$00,$2A,$D4,$12,$1C,$36,$02,$61,$00,$05,$8A
	dc.b $66,$00,$00,$8E,$E7,$4B,$84,$43,$EF,$4A,$3A,$C2,$60,$00,$03,$C2
	dc.b $41,$FA,$01,$18,$61,$00,$FD,$DC,$67,$30,$3A,$3C,$40,$00,$61,$00
	dc.b $05,$C4,$3A,$C5,$61,$00,$01,$46,$70,$FD,$61,$00,$BD,$40,$B2,$3C
	dc.b $00,$2C,$66,$00,$2A,$96,$12,$1C,$61,$00,$05,$4E,$66,$2C,$EF,$4A
	dc.b $20,$6E,$02,$4C,$85,$68,$00,$02,$4E,$75,$61,$00,$C9,$6C,$B2,$3C
	dc.b $00,$2C,$66,$00,$2A,$76,$12,$1C,$EC,$5A,$00,$42,$A0,$00,$3A,$C2
	dc.b $61,$00,$00,$A6,$70,$3D,$60,$00,$BD,$04,$41,$FA,$00,$BE,$61,$00
	dc.b $FD,$82,$66,$16,$61,$00,$00,$96,$20,$6E,$02,$4C,$EC,$5A,$08,$C2
	dc.b $00,$0F,$31,$42,$00,$02,$60,$00,$C9,$30,$70,$57,$60,$00,$2A,$60
	dc.b $3A,$3C,$60,$00,$61,$00,$05,$4E,$EF,$4B,$8A,$43,$3A,$C5,$61,$00
	dc.b $00,$CC,$70,$3D,$61,$00,$BC,$C6,$0C,$2E,$00,$05,$02,$39,$67,$02
	dc.b $4E,$75,$B2,$3C,$00,$7B,$66,$F8,$12,$1C,$B2,$3C,$00,$23,$67,$26
	dc.b $61,$00,$BD,$24,$66,$3C,$4A,$00,$66,$38,$02,$42,$00,$07,$E9,$0A
	dc.b $08,$C2,$00,$0C,$20,$6E,$02,$4C,$85,$68,$00,$02,$B2,$3C,$00,$7D
	dc.b $66,$20,$12,$1C,$4E,$75,$12,$1C,$61,$00,$BC,$4A,$B4,$BC,$FF,$FF
	dc.b $FF,$C0,$6D,$0E,$B4,$BC,$00,$00,$00,$3F,$6E,$06,$02,$42,$00,$7F
	dc.b $60,$D2,$70,$61,$60,$00,$29,$E8,$61,$00,$00,$62,$70,$38,$C0,$45
	dc.b $51,$40,$67,$02,$4E,$75,$20,$6E,$02,$4C,$08,$28,$00,$02,$00,$02
	dc.b $67,$02,$4E,$75,$70,$5F,$60,$00,$29,$C6,$00,$0C,$43,$4F,$4E,$54
	dc.b $52,$4F,$4C,$00,$00,$04,$00,$0A,$46,$50,$43,$52,$00,$00,$00,$04
	dc.b $00,$0A,$46,$50,$49,$41,$52,$00,$00,$01,$00,$0A,$46,$50,$53,$52
	dc.b $00,$00,$00,$02,$00,$0A,$49,$41,$44,$44,$52,$00,$00,$01,$00,$0C
	dc.b $53,$54,$41,$54,$55,$53,$00,$00,$00,$02,$00,$00,$B2,$3C,$00,$23
	dc.b $66,$30,$16,$2E,$02,$39,$B6,$3C,$00,$04,$65,$26,$12,$1C,$16,$2E
	dc.b $02,$39,$61,$00,$04,$80,$66,$00,$29,$62,$06,$03,$00,$F5,$10,$03
	dc.b $16,$2E,$02,$39,$20,$42,$61,$00,$56,$38,$66,$20,$7A,$3C,$60,$00
	dc.b $06,$50,$61,$00,$BD,$42,$BA,$7C,$00,$10,$64,$10,$70,$4E,$14,$2E
	dc.b $02,$39,$05,$00,$66,$06,$70,$5E,$61,$00,$29,$34,$4E,$75,$3C,$3C
	dc.b $F0,$00,$8C,$6E,$01,$30,$3A,$C6,$10,$2E,$02,$39,$B0,$3C,$00,$03
	dc.b $67,$00,$01,$1A,$61,$00,$01,$FA,$3A,$3C,$E0,$00,$61,$00,$00,$CE
	dc.b $66,$2A,$3A,$C5,$B2,$3C,$00,$2C,$66,$00,$28,$E0,$12,$1C,$61,$00
	dc.b $FF,$7C,$70,$34,$61,$00,$BB,$76,$61,$00,$00,$90,$67,$0C,$3A,$28
	dc.b $00,$02,$61,$00,$00,$94,$31,$45,$00,$02,$4E,$75,$61,$00,$03,$C2
	dc.b $66,$2A,$08,$C5,$00,$0B,$E9,$0A,$8A,$02,$3A,$C5,$B2,$3C,$00,$2C
	dc.b $66,$00,$28,$A8,$12,$1C,$61,$00,$FF,$44,$70,$34,$61,$00,$BB,$3E
	dc.b $61,$58,$67,$06,$08,$E8,$00,$04,$00,$02,$4E,$75,$3A,$FC,$D0,$00
	dc.b $61,$00,$FF,$2A,$70,$7D,$61,$00,$BB,$24,$B2,$3C,$00,$2C,$66,$00
	dc.b $28,$7A,$12,$1C,$61,$00,$03,$7A,$66,$14,$20,$6E,$02,$4C,$02,$42
	dc.b $00,$0F,$E9,$4A,$08,$C2,$00,$0B,$85,$68,$00,$02,$4E,$75,$3A,$3C
	dc.b $D0,$00,$61,$00,$00,$38,$66,$0C,$61,$1E,$20,$6E,$02,$4C,$31,$45
	dc.b $00,$02,$4E,$75,$70,$39,$60,$00,$28,$66,$70,$38,$C0,$45,$20,$6E
	dc.b $02,$4C,$B0,$7C,$00,$20,$4E,$75,$10,$05,$E0,$4D,$74,$07,$E2,$10
	dc.b $E3,$55,$51,$CA,$FF,$FA,$08,$C5,$00,$0C,$4E,$75,$61,$00,$02,$DA
	dc.b $67,$02,$4E,$75,$36,$02,$05,$C5,$B2,$3C,$00,$2F,$66,$08,$12,$1C
	dc.b $61,$00,$02,$BA,$60,$EE,$B2,$3C,$00,$2D,$66,$1C,$12,$1C,$61,$00
	dc.b $02,$AC,$B4,$43,$6D,$0C,$07,$C5,$52,$43,$B6,$42,$6F,$F8,$36,$02
	dc.b $60,$D6,$70,$39,$60,$00,$28,$04,$70,$00,$4E,$75,$3A,$3C,$A0,$00
	dc.b $41,$FA,$FE,$38,$61,$00,$FA,$FC,$66,$32,$EC,$5A,$8A,$42,$B2,$3C
	dc.b $00,$2F,$66,$12,$12,$1C,$41,$FA,$FE,$22,$61,$00,$FA,$E6,$67,$EA
	dc.b $70,$39,$60,$00,$27,$DA,$B2,$3C,$00,$2C,$66,$00,$27,$AE,$12,$1C
	dc.b $3A,$C5,$61,$00,$FE,$48,$70,$FF,$60,$00,$BA,$42,$3A,$C5,$61,$00
	dc.b $FE,$3C,$70,$FF,$61,$00,$BA,$36,$B2,$3C,$00,$2C,$66,$00,$27,$8C
	dc.b $12,$1C,$3A,$3C,$80,$00,$41,$FA,$FD,$E2,$61,$00,$FA,$A6,$66,$C0
	dc.b $EC,$5A,$8A,$42,$B2,$3C,$00,$2F,$66,$0E,$12,$1C,$41,$FA,$FD,$CC
	dc.b $61,$00,$FA,$90,$67,$EA,$60,$A8,$20,$6E,$02,$4C,$31,$45,$00,$02
	dc.b $4E,$75,$8C,$6E,$01,$30,$10,$2E,$02,$39,$67,$04,$61,$00,$00,$52
	dc.b $3A,$C6,$B2,$3C,$00,$23,$66,$00,$27,$4A,$12,$1C,$61,$00,$B9,$A6
	dc.b $4A,$82,$6B,$08,$B4,$BC,$00,$00,$00,$40,$65,$06,$70,$1D,$61,$00
	dc.b $27,$4E,$02,$42,$00,$3F,$00,$42,$5C,$00,$B2,$3C,$00,$2C,$66,$00
	dc.b $27,$1A,$12,$1C,$36,$02,$61,$00,$01,$C4,$EF,$4A,$86,$42,$3A,$C3
	dc.b $4E,$75,$8C,$6E,$01,$30,$48,$46,$42,$46,$2A,$C6,$72,$0A,$4E,$75
	dc.b $0C,$2E,$00,$07,$02,$39,$67,$0E,$4A,$2E,$02,$39,$66,$00,$26,$D4
	dc.b $1D,$7C,$00,$07,$02,$39,$4E,$75,$0C,$2E,$00,$3C,$01,$21,$67,$00
	dc.b $00,$0C,$0C,$2E,$00,$28,$01,$21,$66,$00,$D3,$A0,$3A,$06,$3C,$3C
	dc.b $F0,$00,$8C,$6E,$01,$30,$48,$45,$3A,$06,$48,$45,$61,$00,$01,$7A
	dc.b $66,$1E,$EC,$5A,$8A,$42,$ED,$5A,$61,$B6,$B2,$3C,$00,$2C,$66,$06
	dc.b $12,$1C,$61,$00,$01,$58,$3A,$C6,$EF,$5A,$8A,$42,$3A,$C5,$4E,$75
	dc.b $08,$C5,$00,$0E,$61,$00,$01,$AE,$2A,$C5,$61,$00,$FD,$30,$70,$FD
	dc.b $61,$00,$B9,$2A,$B2,$3C,$00,$2C,$66,$00,$26,$80,$12,$1C,$61,$00
	dc.b $01,$2C,$EF,$4A,$20,$6E,$02,$4C,$85,$68,$00,$02,$4E,$75,$8C,$6E
	dc.b $01,$30,$4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$26,$82,$4A,$2E
	dc.b $02,$39,$66,$00,$26,$3E,$61,$00,$B8,$D6,$00,$6C,$4E,$75,$8C,$6E
	dc.b $01,$30,$4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$26,$62,$4A,$2E
	dc.b $02,$39,$66,$00,$26,$1E,$61,$00,$B8,$B6,$00,$34,$4E,$75,$3A,$06
	dc.b $3C,$3C,$F0,$40,$8C,$6E,$01,$30,$48,$45,$3A,$06,$48,$45,$60,$00
	dc.b $08,$54,$8C,$6E,$01,$30,$3A,$C6,$7A,$30,$61,$00,$00,$CC,$66,$2E
	dc.b $EC,$5A,$8A,$42,$61,$00,$FF,$0A,$B2,$3C,$00,$2C,$66,$00,$25,$FC
	dc.b $12,$1C,$61,$00,$00,$A8,$8A,$42,$B2,$3C,$00,$3A,$66,$00,$C5,$E6
	dc.b $12,$1C,$61,$00,$00,$98,$EF,$4A,$8A,$42,$3A,$C5,$4E,$75,$08,$C5
	dc.b $00,$0E,$61,$00,$00,$F0,$3A,$C5,$61,$00,$FC,$72,$70,$FD,$61,$00
	dc.b $B8,$6C,$B2,$3C,$00,$2C,$66,$00,$25,$C2,$12,$1C,$61,$00,$00,$6E
	dc.b $3A,$02,$B2,$3C,$00,$3A,$66,$00,$C5,$AC,$12,$1C,$61,$00,$00,$5E
	dc.b $EF,$4A,$8A,$42,$20,$6E,$02,$4C,$8B,$68,$00,$02,$4E,$75,$3A,$06
	dc.b $3C,$3C,$F0,$78,$8C,$6E,$01,$30,$48,$45,$3A,$06,$48,$45,$2A,$C5
	dc.b $60,$00,$EE,$5A,$3A,$06,$3C,$3C,$F0,$00,$8C,$6E,$01,$30,$48,$45
	dc.b $3A,$06,$48,$45,$61,$00,$00,$32,$66,$0E,$EC,$5A,$8A,$42,$61,$00
	dc.b $FE,$70,$3A,$C6,$3A,$C5,$4E,$75,$08,$C5,$00,$0E,$61,$00,$00,$76
	dc.b $2A,$C5,$61,$00,$FB,$F8,$70,$FD,$60,$00,$B7,$F2,$61,$0A,$66,$02
	dc.b $4E,$75,$70,$57,$60,$00,$25,$64,$10,$01,$20,$4C,$48,$80,$10,$36
	dc.b $00,$7E,$B0,$3C,$00,$46,$66,$34,$10,$18,$48,$80,$10,$36,$00,$7E
	dc.b $B0,$3C,$00,$50,$66,$26,$14,$18,$04,$02,$00,$30,$65,$1E,$B4,$3C
	dc.b $00,$08,$64,$18,$48,$82,$70,$00,$10,$18,$43,$FA,$48,$10,$4A,$31
	dc.b $00,$00,$67,$08,$12,$00,$28,$48,$B0,$00,$4E,$75,$70,$FF,$4E,$75
	dc.b $61,$00,$B8,$14,$66,$0C,$4A,$00,$67,$08,$28,$48,$12,$2C,$FF,$FF
	dc.b $70,$FF,$4E,$75,$70,$00,$10,$2E,$02,$39,$67,$00,$24,$C6,$D0,$40
	dc.b $8A,$7B,$00,$02,$4E,$75,$18,$00,$10,$00,$00,$00,$14,$00,$0C,$00
	dc.b $04,$00,$08,$00,$41,$EE,$08,$7E,$78,$00,$42,$A0,$42,$A0,$42,$A0
	dc.b $48,$83,$B2,$3C,$00,$24,$67,$00,$01,$4C,$B2,$3C,$00,$3A,$67,$00
	dc.b $01,$44,$B2,$3C,$00,$2D,$67,$00,$00,$22,$B2,$3C,$00,$30,$65,$06
	dc.b $B2,$3C,$00,$3A,$65,$30,$61,$00,$B2,$38,$B6,$3C,$00,$0F,$65,$22
	dc.b $B6,$3C,$00,$13,$64,$1C,$70,$00,$4E,$75,$12,$1C,$61,$B6,$66,$10
	dc.b $20,$42,$06,$03,$00,$F5,$61,$00,$52,$0A,$04,$03,$00,$F5,$4A,$00
	dc.b $4E,$75,$70,$64,$4E,$75,$3F,$03,$56,$88,$50,$C2,$76,$01,$78,$FF
	dc.b $7A,$00,$7C,$00,$04,$01,$00,$30,$66,$0E,$4A,$05,$66,$0A,$B6,$3C
	dc.b $00,$01,$67,$14,$53,$44,$60,$10,$61,$00,$00,$C0,$50,$C5,$B6,$3C
	dc.b $00,$FF,$66,$02,$76,$00,$D8,$43,$12,$1C,$B2,$3C,$00,$2E,$66,$0A
	dc.b $B6,$3C,$00,$01,$66,$4E,$16,$05,$60,$EE,$B2,$3C,$00,$30,$65,$06
	dc.b $B2,$3C,$00,$3A,$65,$BE,$B2,$3C,$00,$45,$67,$06,$B2,$3C,$00,$65
	dc.b $66,$32,$76,$00,$12,$1C,$B2,$3C,$00,$2D,$57,$C2,$66,$02,$12,$1C
	dc.b $B2,$3C,$00,$30,$65,$16,$B2,$3C,$00,$3A,$64,$10,$04,$01,$00,$30
	dc.b $02,$41,$00,$FF,$C6,$FC,$00,$0A,$D6,$41,$60,$E2,$4A,$02,$67,$02
	dc.b $44,$43,$D8,$43,$41,$EE,$08,$72,$7C,$00,$4A,$05,$67,$36,$4A,$44
	dc.b $6A,$06,$08,$D0,$00,$06,$44,$44,$50,$C2,$02,$84,$00,$00,$FF,$FF
	dc.b $88,$FC,$03,$E8,$3A,$04,$42,$44,$48,$44,$88,$FC,$00,$64,$61,$28
	dc.b $42,$44,$48,$44,$88,$FC,$00,$0A,$61,$1E,$42,$44,$48,$44,$61,$18
	dc.b $12,$2C,$FF,$FF,$41,$EE,$08,$72,$36,$1F,$61,$00,$50,$58,$06,$43
	dc.b $00,$0B,$24,$08,$4A,$40,$4E,$75,$12,$04,$4A,$02,$67,$08,$83,$18
	dc.b $52,$06,$46,$02,$4E,$75,$BC,$3C,$00,$09,$67,$06,$E9,$49,$83,$10
	dc.b $46,$02,$4E,$75,$24,$4C,$43,$FA,$B3,$42,$12,$1C,$48,$81,$6B,$0C
	dc.b $14,$31,$10,$00,$6B,$06,$70,$04,$61,$28,$60,$EE,$70,$00,$10,$3B
	dc.b $30,$19,$67,$14,$74,$00,$3F,$00,$B0,$7C,$00,$20,$6D,$02,$70,$10
	dc.b $91,$57,$61,$0E,$30,$1F,$66,$EE,$60,$A4,$58,$50,$40,$20,$00,$40
	dc.b $00,$00,$2F,$09,$4A,$40,$67,$1A,$48,$40,$42,$40,$D1,$00,$48,$40
	dc.b $41,$EE,$08,$7E,$22,$48,$D3,$88,$D3,$88,$D3,$88,$65,$28,$53,$40
	dc.b $66,$EE,$D1,$00,$48,$82,$48,$C2,$41,$EE,$08,$7E,$20,$20,$D1,$82
	dc.b $20,$80,$74,$00,$20,$20,$D1,$82,$20,$80,$20,$20,$D1,$82,$65,$06
	dc.b $20,$80,$22,$5F,$4E,$75,$70,$5D,$61,$00,$23,$04,$22,$5F,$4E,$75
	dc.b $20,$42,$48,$83,$10,$3B,$30,$13,$6B,$08,$3A,$D8,$53,$00,$66,$FA
	dc.b $4E,$75,$70,$00,$10,$18,$3A,$C0,$4E,$75,$FF,$01,$02,$04,$06,$02
	dc.b $06,$00,$4A,$2E,$01,$23,$66,$0A,$0C,$2E,$00,$14,$01,$21,$66,$00
	dc.b $CF,$7A,$4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$22,$C2,$10,$2E
	dc.b $02,$39,$67,$16,$B0,$3C,$00,$02,$67,$10,$B0,$3C,$00,$03,$66,$00
	dc.b $22,$72,$08,$C6,$00,$06,$60,$00,$BE,$50,$60,$00,$BE,$CC,$4A,$2E
	dc.b $01,$23,$66,$0A,$0C,$2E,$00,$14,$01,$21,$66,$00,$CF,$3E,$4A,$2E
	dc.b $01,$25,$67,$06,$70,$65,$61,$00,$22,$86,$3A,$06,$3C,$3C,$F0,$48
	dc.b $48,$45,$3A,$06,$48,$45,$4A,$2E,$02,$39,$66,$00,$22,$36,$61,$00
	dc.b $B5,$48,$48,$45,$8A,$02,$48,$45,$2A,$C5,$B2,$3C,$00,$2C,$66,$00
	dc.b $22,$3A,$12,$1C,$61,$00,$BF,$02,$66,$04,$54,$8D,$4E,$75,$55,$82
	dc.b $4A,$43,$6B,$00,$36,$B2,$61,$00,$16,$7C,$3A,$C2,$4E,$75,$0C,$2E
	dc.b $00,$3C,$01,$21,$67,$0A,$0C,$2E,$00,$28,$01,$21,$66,$00,$00,$14
	dc.b $4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$22,$24,$3A,$FC,$F5,$18
	dc.b $4E,$75,$4A,$2E,$01,$23,$66,$0A,$0C,$2E,$00,$1E,$01,$21,$66,$00
	dc.b $CE,$BA,$4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$22,$02,$3A,$C6
	dc.b $3A,$FC,$24,$00,$4E,$75,$0C,$2E,$00,$3C,$01,$21,$67,$0A,$0C,$2E
	dc.b $00,$28,$01,$21,$66,$00,$CE,$94,$4A,$2E,$01,$25,$67,$06,$70,$65
	dc.b $61,$00,$21,$DC,$3A,$C6,$61,$00,$B5,$CE,$10,$05,$02,$00,$00,$38
	dc.b $B0,$3C,$00,$10,$66,$0E,$02,$05,$00,$07,$20,$6E,$02,$4C,$8A,$50
	dc.b $30,$85,$4E,$75,$70,$68,$60,$00,$21,$B6,$0C,$2E,$00,$3C,$01,$21
	dc.b $67,$0A,$0C,$2E,$00,$28,$01,$21,$66,$00,$CE,$50,$4A,$2E,$01,$25
	dc.b $67,$06,$70,$65,$61,$00,$21,$98,$3A,$C6,$4E,$75,$0C,$2E,$00,$3C
	dc.b $01,$21,$67,$0A,$0C,$2E,$00,$28,$01,$21,$66,$00,$00,$14,$4A,$2E
	dc.b $01,$25,$67,$06,$70,$65,$61,$00,$21,$76,$3C,$3C,$F5,$08,$60,$94
	dc.b $4A,$2E,$01,$23,$66,$0A,$0C,$2E,$00,$1E,$01,$21,$66,$00,$CE,$0C
	dc.b $4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$21,$54,$34,$3C,$30,$00
	dc.b $3A,$C6,$61,$00,$00,$5C,$B2,$3C,$00,$2C,$66,$00,$21,$1E,$12,$1C
	dc.b $B2,$3C,$00,$23,$66,$00,$21,$1C,$12,$1C,$3F,$02,$61,$00,$B3,$76
	dc.b $36,$1F,$4A,$2E,$01,$23,$56,$C0,$02,$80,$00,$00,$00,$08,$00,$00
	dc.b $00,$07,$4A,$82,$6B,$04,$B4,$80,$6F,$08,$70,$59,$61,$00,$21,$10
	dc.b $74,$00,$EB,$4A,$84,$43,$B2,$3C,$00,$2C,$67,$04,$3A,$C2,$4E,$75
	dc.b $12,$1C,$08,$C2,$00,$0B,$3A,$C2,$61,$00,$B3,$4E,$00,$24,$4E,$75
	dc.b $B2,$3C,$00,$23,$67,$6E,$48,$81,$12,$36,$10,$7E,$B2,$3C,$00,$53
	dc.b $67,$40,$B2,$3C,$00,$44,$66,$56,$12,$1C,$04,$01,$00,$30,$65,$4E
	dc.b $B2,$3C,$00,$08,$65,$22,$B2,$3C,$00,$16,$67,$06,$B2,$3C,$00,$36
	dc.b $66,$3C,$12,$1C,$B2,$3C,$00,$43,$67,$06,$B2,$3C,$00,$63,$66,$2E
	dc.b $00,$42,$00,$01,$12,$1C,$4E,$75,$08,$C1,$00,$03,$84,$01,$12,$1C
	dc.b $4E,$75,$12,$1C,$B2,$3C,$00,$46,$67,$06,$B2,$3C,$00,$66,$66,$0E
	dc.b $12,$1C,$B2,$3C,$00,$43,$67,$DC,$B2,$3C,$00,$63,$67,$D6,$70,$59
	dc.b $60,$00,$20,$78,$12,$1C,$3F,$02,$61,$00,$B2,$BA,$4A,$2E,$01,$23
	dc.b $56,$C0,$02,$80,$00,$00,$00,$08,$00,$00,$00,$07,$4A,$82,$6B,$04
	dc.b $B4,$80,$6F,$08,$70,$59,$61,$00,$20,$56,$74,$00,$84,$5F,$08,$C2
	dc.b $00,$04,$4E,$75,$4A,$2E,$01,$23,$66,$0A,$0C,$2E,$00,$14,$01,$21
	dc.b $66,$00,$CC,$E8,$4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$20,$30
	dc.b $34,$3C,$34,$00,$60,$00,$FE,$DA,$4A,$2E,$01,$23,$66,$0A,$0C,$2E
	dc.b $00,$14,$01,$21,$66,$00,$CC,$C4,$4A,$2E,$01,$25,$67,$06,$70,$65
	dc.b $61,$00,$20,$0C,$3A,$C6,$3A,$FC,$A0,$00,$61,$00,$B2,$5C,$00,$FC
	dc.b $4E,$75,$4A,$2E,$01,$23,$66,$0A,$0C,$2E,$00,$1E,$01,$21,$66,$00
	dc.b $CC,$9A,$4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$1F,$E2,$3A,$FC
	dc.b $F0,$00,$34,$06,$61,$00,$FE,$EA,$3A,$C2,$B2,$3C,$00,$2C,$66,$00
	dc.b $1F,$AA,$12,$1C,$61,$00,$B2,$22,$00,$24,$4E,$75,$0C,$2E,$00,$1E
	dc.b $01,$21,$66,$00,$CC,$66,$4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00
	dc.b $1F,$AE,$3A,$FC,$F0,$00,$34,$3C,$01,$00,$60,$48,$4A,$2E,$01,$23
	dc.b $66,$0A,$0C,$2E,$00,$1E,$01,$21,$66,$00,$CC,$40,$4A,$2E,$01,$25
	dc.b $67,$06,$70,$65,$61,$00,$1F,$88,$3A,$FC,$F0,$00,$61,$58,$66,$22
	dc.b $08,$C2,$00,$09,$3A,$C2,$B2,$3C,$00,$2C,$66,$00,$1F,$4E,$12,$1C
	dc.b $61,$00,$F5,$EA,$70,$3F,$4A,$2E,$01,$23,$66,$02,$70,$24,$60,$00
	dc.b $B1,$DC,$74,$00,$4A,$2E,$02,$39,$67,$00,$1F,$18,$3A,$C2,$61,$00
	dc.b $F5,$CC,$70,$24,$61,$00,$B1,$C6,$B2,$3C,$00,$2C,$66,$00,$1F,$1C
	dc.b $12,$1C,$61,$12,$66,$0A,$20,$6E,$02,$4C,$85,$68,$00,$02,$4E,$75
	dc.b $70,$58,$60,$00,$1F,$2A,$41,$FA,$00,$4E,$61,$00,$F2,$26,$66,$44
	dc.b $10,$02,$6A,$1E,$4A,$2E,$01,$23,$66,$0A,$0C,$2E,$00,$14,$01,$21
	dc.b $66,$00,$CB,$B8,$4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$1F,$00
	dc.b $60,$10,$08,$00,$00,$06,$67,$0A,$0C,$2E,$00,$1E,$01,$21,$66,$00
	dc.b $CB,$9A,$42,$02,$D4,$42,$D4,$42,$02,$00,$00,$3F,$B0,$2E,$02,$39
	dc.b $66,$00,$1E,$A0,$4E,$75,$00,$08,$41,$43,$00,$00,$17,$82,$00,$08
	dc.b $42,$41,$43,$00,$1D,$82,$00,$08,$42,$41,$44,$00,$1C,$82,$00,$08
	dc.b $43,$41,$4C,$00,$14,$81,$00,$08,$43,$52,$50,$00,$13,$04,$00,$08
	dc.b $44,$52,$50,$00,$11,$84,$00,$0A,$4D,$4D,$55,$53,$52,$00,$18,$02
	dc.b $00,$0A,$50,$43,$53,$52,$00,$00,$19,$82,$00,$08,$50,$53,$52,$00
	dc.b $18,$02,$00,$08,$53,$43,$43,$00,$16,$81,$00,$08,$53,$52,$50,$00
	dc.b $12,$04,$00,$08,$54,$43,$00,$00,$10,$03,$00,$08,$54,$54,$30,$00
	dc.b $02,$43,$00,$08,$54,$54,$31,$00,$03,$43,$00,$08,$56,$41,$4C,$00
	dc.b $2B,$81,$00,$00,$4A,$2E,$01,$23,$66,$0A,$0C,$2E,$00,$14,$01,$21
	dc.b $66,$00,$CA,$F8,$4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$1E,$40
	dc.b $61,$00,$B0,$9C,$00,$6C,$4E,$75,$4A,$2E,$01,$23,$66,$0A,$0C,$2E
	dc.b $00,$14,$01,$21,$66,$00,$CA,$D4,$4A,$2E,$01,$25,$67,$06,$70,$65
	dc.b $61,$00,$1E,$1C,$61,$00,$B0,$78,$00,$34,$4E,$75,$4A,$2E,$01,$23
	dc.b $66,$0A,$0C,$2E,$00,$14,$01,$21,$66,$00,$CA,$B0,$4A,$2E,$01,$25
	dc.b $67,$06,$70,$65,$61,$00,$1D,$F8,$3A,$06,$3C,$3C,$F0,$40,$48,$45
	dc.b $3A,$06,$48,$45,$2A,$C5,$61,$00,$BC,$D2,$50,$EE,$02,$3B,$61,$00
	dc.b $B0,$38,$00,$3D,$4E,$75,$08,$06,$00,$0F,$67,$00,$00,$2E,$0C,$2E
	dc.b $00,$28,$01,$21,$66,$00,$00,$42,$4A,$2E,$01,$25,$67,$06,$70,$65
	dc.b $61,$00,$1D,$BC,$08,$06,$00,$09,$66,$08,$3C,$3C,$F5,$48,$60,$00
	dc.b $FB,$D4,$3C,$3C,$F5,$68,$60,$00,$FB,$CC,$0C,$2E,$00,$3C,$01,$21
	dc.b $66,$00,$CA,$48,$4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$1D,$90
	dc.b $00,$46,$F5,$88,$60,$00,$FB,$AE,$4A,$2E,$01,$23,$66,$0A,$0C,$2E
	dc.b $00,$1E,$01,$21,$66,$00,$CA,$24,$4A,$2E,$01,$25,$67,$06,$70,$65
	dc.b $61,$00,$1D,$6C,$4A,$2E,$02,$39,$66,$00,$1D,$28,$3A,$FC,$F0,$00
	dc.b $34,$06,$61,$00,$FC,$6C,$3A,$C2,$B2,$3C,$00,$2C,$66,$00,$1D,$2C
	dc.b $12,$1C,$61,$00,$AF,$A4,$00,$24,$B2,$3C,$00,$2C,$66,$00,$1D,$1C
	dc.b $12,$1C,$B2,$3C,$00,$23,$66,$00,$1D,$1A,$12,$1C,$61,$00,$AF,$76
	dc.b $4A,$82,$6B,$08,$B4,$BC,$00,$00,$00,$08,$65,$08,$70,$1D,$61,$00
	dc.b $1D,$1E,$74,$00,$EC,$5A,$B2,$3C,$00,$2C,$66,$14,$12,$1C,$36,$02
	dc.b $61,$00,$AF,$F0,$08,$C3,$00,$08,$02,$42,$00,$07,$EB,$4A,$84,$43
	dc.b $20,$6E,$02,$4C,$85,$68,$00,$02,$4E,$75,$4A,$2E,$01,$23,$66,$0A
	dc.b $0C,$2E,$00,$14,$01,$21,$66,$00,$C9,$92,$4A,$2E,$01,$25,$67,$06
	dc.b $70,$65,$61,$00,$1C,$DA,$3A,$FC,$F0,$78,$3A,$C6,$60,$00,$E5,$7E
	dc.b $4A,$2E,$01,$23,$66,$0A,$0C,$2E,$00,$14,$01,$21,$66,$00,$C9,$6C
	dc.b $4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$1C,$B4,$3A,$FC,$F0,$00
	dc.b $61,$00,$AF,$A4,$66,$24,$4A,$00,$67,$1A,$36,$3C,$2C,$00,$86,$02
	dc.b $3A,$C3,$B2,$3C,$00,$2C,$66,$00,$1C,$72,$12,$1C,$61,$00,$AE,$EA
	dc.b $00,$24,$4E,$75,$70,$0E,$60,$00,$1C,$86,$48,$81,$12,$36,$10,$7E
	dc.b $B2,$3C,$00,$56,$66,$EE,$12,$1C,$48,$81,$12,$36,$10,$7E,$B2,$3C
	dc.b $00,$41,$66,$E0,$12,$1C,$48,$81,$12,$36,$10,$7E,$B2,$3C,$00,$4C
	dc.b $66,$D2,$12,$1C,$3A,$FC,$28,$00,$60,$B8,$0C,$2E,$00,$20,$01,$21
	dc.b $66,$00,$C8,$F8,$3A,$C6,$4E,$75,$0C,$2E,$00,$3C,$01,$21,$67,$00
	dc.b $00,$0C,$0C,$2E,$00,$20,$01,$21,$66,$00,$C8,$E0,$4A,$2E,$01,$25
	dc.b $67,$06,$70,$65,$61,$00,$1C,$28,$B2,$3C,$00,$23,$66,$00,$1C,$04
	dc.b $12,$1C,$3A,$FC,$F8,$00,$3A,$C6,$61,$00,$B2,$2A,$60,$00,$BE,$F4
	dc.b $0C,$2E,$00,$20,$01,$21,$66,$00,$C8,$B2,$61,$00,$E6,$96,$3A,$FC
	dc.b $F8,$00,$3A,$C6,$61,$00,$AE,$52,$00,$65,$20,$6E,$02,$4C,$30,$10
	dc.b $02,$00,$00,$38,$66,$18,$B2,$3C,$00,$3A,$66,$00,$BB,$B8,$12,$1C
	dc.b $61,$00,$AE,$B6,$20,$6E,$02,$4C,$85,$28,$00,$03,$60,$06,$08,$E8
	dc.b $00,$00,$00,$02,$B2,$3C,$00,$2C,$66,$00,$1B,$A0,$12,$1C,$61,$00
	dc.b $AE,$98,$20,$6E,$02,$4C,$E9,$0A,$85,$28,$00,$02,$4E,$75,$0C,$2E
	dc.b $00,$3C,$01,$21,$67,$0A,$0C,$2E,$00,$28,$01,$21,$66,$00,$C8,$4C
	dc.b $4A,$2E,$01,$25,$67,$06,$70,$65,$61,$00,$1B,$94,$41,$FA,$00,$1C
	dc.b $61,$00,$EE,$90,$8C,$42,$3A,$C6,$4E,$75,$61,$D2,$B2,$3C,$00,$2C
	dc.b $66,$00,$1B,$58,$12,$1C,$60,$00,$F9,$9E,$00,$08,$42,$43,$00,$00
	dc.b $00,$C0,$00,$08,$44,$43,$00,$00,$00,$40,$00,$08,$49,$43,$00,$00
	dc.b $00,$80,$00,$08,$4E,$43,$00,$00,$00,$00,$00,$00,$0C,$2E,$00,$3C
	dc.b $01,$21,$67,$00,$00,$0C,$0C,$2E,$00,$28,$01,$21,$66,$00,$C7,$EC
	dc.b $3A,$C6,$61,$00,$AF,$32,$B2,$3C,$00,$2C,$66,$00,$1B,$0E,$12,$1C
	dc.b $10,$05,$02,$00,$00,$3F,$B0,$3C,$00,$39,$67,$6A,$02,$00,$00,$30
	dc.b $B0,$3C,$00,$10,$66,$00,$1A,$F0,$3F,$05,$61,$00,$AF,$0A,$30,$05
	dc.b $02,$00,$00,$38,$B0,$3C,$00,$18,$66,$30,$10,$05,$02,$40,$00,$07
	dc.b $E8,$58,$00,$40,$80,$00,$3A,$C0,$3A,$1F,$08,$C5,$00,$05,$08,$05
	dc.b $00,$03,$67,$00,$1A,$C2,$02,$45,$00,$27,$20,$6E,$02,$4C,$30,$10
	dc.b $02,$40,$FF,$C0,$8A,$40,$30,$85,$4E,$75,$30,$05,$02,$40,$00,$3F
	dc.b $B0,$3C,$00,$39,$66,$00,$1A,$A0,$3A,$1F,$08,$05,$00,$03,$67,$DA
	dc.b $02,$45,$00,$07,$60,$D4,$61,$00,$AE,$AE,$30,$05,$02,$40,$00,$38
	dc.b $B0,$3C,$00,$10,$66,$0A,$70,$18,$02,$45,$00,$07,$8A,$40,$60,$BA
	dc.b $B0,$3C,$00,$18,$66,$00,$1A,$70,$70,$08,$60,$EC,$70,$37,$60,$00
	dc.b $1A,$8A,$14,$01,$B2,$3C,$00,$22,$67,$06,$B2,$3C,$00,$27,$66,$EC
	dc.b $24,$4C,$12,$1C,$B2,$3C,$00,$0A,$67,$E2,$B2,$02,$66,$F4,$12,$1C
	dc.b $B2,$02,$67,$EE,$28,$0C,$98,$8A,$53,$44,$B2,$3C,$00,$2C,$66,$00
	dc.b $1A,$3A,$12,$1C,$16,$01,$B2,$3C,$00,$27,$67,$06,$B2,$3C,$00,$22
	dc.b $66,$BA,$53,$44,$65,$06,$B5,$0C,$67,$F8,$4E,$75,$70,$0A,$C1,$41
	dc.b $B0,$03,$66,$06,$52,$8C,$12,$1C,$70,$00,$4E,$75,$61,$A4,$57,$C0
	dc.b $60,$00,$00,$D8,$61,$9C,$56,$C0,$60,$00,$00,$D0,$61,$00,$AA,$5C
	dc.b $67,$1E,$61,$00,$A1,$62,$66,$18,$4A,$2E,$02,$38,$67,$12,$10,$29
	dc.b $00,$0C,$08,$00,$00,$07,$67,$08,$02,$00,$00,$40,$B0,$3C,$00,$40
	dc.b $4E,$75,$41,$EE,$03,$E8,$61,$00,$0C,$28,$66,$00,$19,$F2,$61,$CC
	dc.b $57,$C0,$60,$00,$00,$96,$41,$EE,$03,$E8,$61,$00,$0C,$14,$66,$00
	dc.b $19,$DE,$61,$B8,$56,$C0,$60,$00,$00,$82,$50,$EE,$01,$58,$61,$00
	dc.b $A2,$FE,$51,$EE,$01,$58,$4A,$43,$6B,$2C,$4A,$04,$66,$28,$4E,$75
	dc.b $61,$E8,$B6,$3C,$00,$02,$67,$1E,$4E,$75,$50,$EE,$01,$58,$61,$00
	dc.b $A2,$DE,$51,$EE,$01,$58,$4A,$43,$6B,$0C,$B6,$3C,$00,$01,$67,$06
	dc.b $4A,$04,$66,$02,$4E,$75,$70,$3E,$60,$00,$19,$90,$61,$DC,$1D,$7C
	dc.b $00,$3D,$08,$3B,$2D,$42,$08,$3C,$4E,$75,$70,$33,$60,$00,$19,$7C
loc_0_00006B08:
	move.w #$34,d0
...
loc_0_00007880:
	...
	dc.b $00,$01,$67,$10,$30,$02,$48,$C0,$B4,$80,$66,$02,$4E,$75,$70,$1D
	dc.b $60,$00,$0B,$BC,$70,$1E,$4A,$2E,$01,$07,$67,$00,$0B,$B2,$4E,$75
	dc.b $B6,$3C,$00,$01,$67,$EE,$4E,$75
loc_0_000078E0:
	movea.l a4,a0
...
loc_0_00007934:
	move.l a1,app_013E(a6)
	lea.l $0010(a1),a1
	move.l a1,app_0162(a6)
	rts
loc_0_00007942:
	tst.b d0
...
loc_0_00007976:
	...
	move.b d0,$000E(a1)
loc_0_000079B2:
	move.l a1,app_0142(a6)
	move.l $0008(a1),app_023C(a6)
	move.b $000E(a1),app_0146(a6)
...
loc_0_00007A0C:
	...
	dc.b $2F,$08,$20,$6E,$08,$9C,$31,$7C,$2D,$2D,$FF,$FC,$20,$5F,$4E,$75
loc_0_00007A30:
	dc.b $6C,$69,$6E,$65,$20,$6D,$61,$6C,$66,$6F,$72,$6D,$65,$64,$00,$6F
	dc.b $75,$74,$20,$6F,$66,$20,$6D,$65,$6D,$6F,$72,$79,$00,$75,$6E,$64
	dc.b $65,$66,$69,$6E,$65,$64,$20,$73,$79,$6D,$62,$6F,$6C,$00,$61,$64
	dc.b $64,$69,$74,$69,$6F,$6E,$61,$6C,$20,$73,$79,$6D,$62,$6F,$6C,$20
	dc.b $6F,$6E,$20,$70,$61,$73,$73,$20,$32,$00,$73,$79,$6D,$62,$6F,$6C
	dc.b $20,$64,$65,$66,$69,$6E,$65,$64,$20,$74,$77,$69,$63,$65,$00,$70
	dc.b $68,$61,$73,$69,$6E,$67,$20,$65,$72,$72,$6F,$72,$00,$6C,$6F,$63
	dc.b $61,$6C,$20,$6E,$6F,$74,$20,$61,$6C,$6C,$6F,$77,$65,$64,$00,$49
	dc.b $4E,$54,$45,$52,$4E,$41,$4C,$3A,$69,$6E,$76,$61,$6C,$69,$64,$20
	dc.b $68,$61,$73,$68,$69,$6E,$67,$00,$69,$6E,$73,$74,$72,$75,$63,$74
	dc.b $69,$6F,$6E,$20,$6E,$6F,$74,$20,$72,$65,$63,$6F,$67,$6E,$69,$73
	dc.b $65,$64,$00,$69,$6E,$76,$61,$6C,$69,$64,$20,$73,$69,$7A,$65,$00
	dc.b $64,$75,$70,$6C,$69,$63,$61,$74,$65,$20,$4D,$4F,$44,$55,$4C,$45
	dc.b $20,$6E,$61,$6D,$65,$00,$66,$6F,$72,$77,$61,$72,$64,$20,$72,$65
	dc.b $66,$65,$72,$65,$6E,$63,$65,$00,$69,$6E,$76,$61,$6C,$69,$64,$20
	dc.b $73,$65,$63,$74,$69,$6F,$6E,$20,$6E,$61,$6D,$65,$2C,$20,$54,$45
	dc.b $58,$54,$20,$61,$73,$73,$75,$6D,$65,$64,$00,$67,$61,$72,$62,$61
	dc.b $67,$65,$20,$66,$6F,$6C,$6C,$6F,$77,$69,$6E,$67,$20,$69,$6E,$73
	dc.b $74,$72,$75,$63,$74,$69,$6F,$6E,$00,$61,$64,$64,$72,$65,$73,$73
	dc.b $69,$6E,$67,$20,$6D,$6F,$64,$65,$20,$6E,$6F,$74,$20,$72,$65,$63
	dc.b $6F,$67,$6E,$69,$73,$65,$64,$00,$61,$64,$64,$72,$65,$73,$73,$20
	dc.b $72,$65,$67,$69,$73,$74,$65,$72,$20,$65,$78,$70,$65,$63,$74,$65
	dc.b $64,$00,$61,$64,$64,$72,$65,$73,$73,$69,$6E,$67,$20,$6D,$6F,$64
	dc.b $65,$20,$6E,$6F,$74,$20,$61,$6C,$6C,$6F,$77,$65,$64,$00,$65,$78
	dc.b $70,$72,$65,$73,$73,$69,$6F,$6E,$20,$6D,$69,$73,$6D,$61,$74,$63
	dc.b $68,$00,$6D,$69,$73,$73,$69,$6E,$67,$20,$63,$6C,$6F,$73,$65,$20
	dc.b $62,$72,$61,$63,$6B,$65,$74,$00,$69,$6D,$70,$6F,$72,$74,$65,$64
	dc.b $20,$6C,$61,$62,$65,$6C,$20,$6E,$6F,$74,$20,$61,$6C,$6C,$6F,$77
	dc.b $65,$64,$00,$69,$6C,$6C,$65,$67,$61,$6C,$20,$74,$79,$70,$65,$20
	dc.b $63,$6F,$6D,$62,$69,$6E,$61,$74,$69,$6F,$6E,$00,$69,$6E,$76,$61
	dc.b $6C,$69,$64,$20,$6E,$75,$6D,$62,$65,$72,$00,$6E,$75,$6D,$62,$65
	dc.b $72,$20,$74,$6F,$6F,$20,$6C,$61,$72,$67,$65,$00,$6D,$69,$73,$75
	dc.b $73,$65,$20,$6F,$66,$20,$6C,$61,$62,$65,$6C,$00,$69,$6E,$63,$6C
	dc.b $75,$64,$65,$20,$66,$69,$6C,$65,$20,$72,$65,$61,$64,$20,$65,$72
	dc.b $72,$6F,$72,$00,$66,$69,$6C,$65,$20,$6E,$6F,$74,$20,$66,$6F,$75
	dc.b $6E,$64,$00,$68,$65,$61,$64,$65,$72,$20,$66,$69,$6C,$65,$20,$6E
	dc.b $6F,$74,$20,$66,$6F,$75,$6E,$64,$00,$72,$65,$70,$65,$61,$74,$65
	dc.b $64,$20,$69,$6E,$63,$6C,$75,$64,$65,$20,$66,$69,$6C,$65,$00,$64
	dc.b $61,$74,$61,$20,$74,$6F,$6F,$20,$6C,$61,$72,$67,$65,$00,$72,$65
	dc.b $6C,$61,$74,$69,$76,$65,$20,$6E,$6F,$74,$20,$61,$6C,$6C,$6F,$77
	dc.b $65,$64,$00,$63,$6F,$6D,$6D,$61,$20,$65,$78,$70,$65,$63,$74,$65
	dc.b $64,$00,$2E,$57,$20,$6F,$72,$20,$2E,$4C,$20,$65,$78,$70,$65,$63
	dc.b $74,$65,$64,$20,$61,$73,$20,$69,$6E,$64,$65,$78,$20,$73,$69,$7A
	dc.b $65,$00,$61,$62,$73,$6F,$6C,$75,$74,$65,$20,$6E,$6F,$74,$20,$61
	dc.b $6C,$6C,$6F,$77,$65,$64,$00,$77,$72,$6F,$6E,$67,$20,$70,$72,$6F
	dc.b $63,$65,$73,$73,$6F,$72,$00,$6F,$64,$64,$20,$61,$64,$64,$72,$65
	dc.b $73,$73,$00,$69,$6D,$6D,$65,$64,$69,$61,$74,$65,$20,$64,$61,$74
	dc.b $61,$20,$65,$78,$70,$65,$63,$74,$65,$64,$00,$64,$61,$74,$61,$20
	dc.b $72,$65,$67,$69,$73,$74,$65,$72,$20,$65,$78,$70,$65,$63,$74,$65
	dc.b $64,$00,$42,$53,$53,$20,$6F,$72,$20,$4F,$46,$46,$53,$45,$54,$20
	dc.b $73,$65,$63,$74,$69,$6F,$6E,$20,$63,$61,$6E,$6E,$6F,$74,$20,$63
	dc.b $6F,$6E,$74,$61,$69,$6E,$20,$64,$61,$74,$61,$00,$64,$75,$72,$69
	dc.b $6E,$67,$20,$77,$72,$69,$74,$69,$6E,$67,$20,$62,$69,$6E,$61,$72
	dc.b $79,$20,$66,$69,$6C,$65,$00,$63,$61,$6E,$6E,$6F,$74,$20,$63,$72
	dc.b $65,$61,$74,$65,$20,$62,$69,$6E,$61,$72,$79,$20,$66,$69,$6C,$65
	dc.b $00,$73,$79,$6D,$62,$6F,$6C,$20,$65,$78,$70,$65,$63,$74,$65,$64
	dc.b $00,$58,$52,$45,$46,$73,$20,$6E,$6F,$74,$20,$61,$6C,$6C,$6F,$77
	dc.b $65,$64,$20,$77,$69,$74,$68,$69,$6E,$20,$62,$72,$61,$63,$6B,$65
	dc.b $74,$73,$00,$63,$61,$6E,$6E,$6F,$74,$20,$69,$6D,$70,$6F,$72,$74
	dc.b $20,$73,$79,$6D,$62,$6F,$6C,$00,$63,$61,$6E,$6E,$6F,$74,$20,$65
	dc.b $78,$70,$6F,$72,$74,$20,$73,$79,$6D,$62,$6F,$6C,$00,$6E,$6F,$74
	dc.b $20,$79,$65,$74,$20,$69,$6D,$70,$6C,$65,$6D,$65,$6E,$74,$65,$64
	dc.b $00,$72,$65,$67,$69,$73,$74,$65,$72,$20,$65,$78,$70,$65,$63,$74
	dc.b $65,$64,$00,$69,$6E,$76,$61,$6C,$69,$64,$20,$4D,$4F,$56,$45,$50
	dc.b $20,$61,$64,$64,$72,$65,$73,$73,$69,$6E,$67,$20,$6D,$6F,$64,$65
	dc.b $00,$73,$70,$75,$72,$69,$6F,$75,$73,$20,$45,$4E,$44,$43,$00,$73
	dc.b $70,$75,$72,$69,$6F,$75,$73,$20,$45,$4C,$53,$45,$00,$6D,$69,$73
	dc.b $73,$69,$6E,$67,$20,$45,$4E,$44,$43,$00,$69,$6E,$76,$61,$6C,$69
	dc.b $64,$20,$49,$46,$20,$65,$78,$70,$72,$65,$73,$73,$69,$6F,$6E,$2C
	dc.b $20,$69,$67,$6E,$6F,$72,$65,$64,$00,$73,$6F,$75,$72,$63,$65,$20
	dc.b $65,$78,$70,$69,$72,$65,$64,$20,$70,$72,$65,$6D,$61,$74,$75,$72
	dc.b $65,$6C,$79,$00,$73,$70,$75,$72,$69,$6F,$75,$73,$20,$45,$4E,$44
	dc.b $4D,$20,$6F,$72,$20,$4D,$45,$58,$49,$54,$00,$63,$61,$6E,$6E,$6F
	dc.b $74,$20,$6E,$65,$73,$74,$20,$4D,$41,$43,$52,$4F,$20,$64,$65,$66
	dc.b $69,$6E,$69,$74,$69,$6F,$6E,$73,$20,$6F,$72,$20,$64,$65,$66,$69
	dc.b $6E,$65,$20,$69,$6E,$20,$52,$45,$50,$54,$73,$00,$6D,$69,$73,$73
	dc.b $69,$6E,$67,$20,$71,$75,$6F,$74,$65,$00,$75,$73,$65,$72,$20,$65
	dc.b $72,$72,$6F,$72,$00,$69,$6E,$76,$61,$6C,$69,$64,$20,$72,$65,$67
	dc.b $69,$73,$74,$65,$72,$20,$6C,$69,$73,$74,$00,$69,$6E,$76,$61,$6C
	dc.b $69,$64,$20,$6F,$70,$74,$69,$6F,$6E,$00,$66,$61,$74,$61,$6C,$6C
	dc.b $79,$20,$62,$61,$64,$20,$63,$6F,$6E,$64,$69,$74,$69,$6F,$6E,$61
	dc.b $6C,$00,$72,$65,$6C,$6F,$63,$61,$74,$69,$6F,$6E,$20,$6E,$6F,$74
	dc.b $20,$61,$6C,$6C,$6F,$77,$65,$64,$00,$64,$69,$76,$69,$73,$69,$6F
	dc.b $6E,$20,$62,$79,$20,$7A,$65,$72,$6F,$00,$61,$62,$73,$6F,$6C,$75
	dc.b $74,$65,$20,$65,$78,$70,$72,$65,$73,$73,$69,$6F,$6E,$20,$4D,$55
	dc.b $53,$54,$20,$65,$76,$61,$6C,$75,$61,$74,$65,$00,$69,$6C,$6C,$65
	dc.b $67,$61,$6C,$20,$42,$53,$52,$2E,$53,$00,$6F,$70,$74,$69,$6F,$6E
	dc.b $20,$6D,$75,$73,$74,$20,$62,$65,$20,$61,$74,$20,$73,$74,$61,$72
	dc.b $74,$00,$49,$4E,$54,$45,$52,$4E,$41,$4C,$3A,$69,$6E,$76,$61,$6C
	dc.b $69,$64,$20,$6F,$70,$74,$69,$6D,$69,$73,$61,$74,$69,$6F,$6E,$00
	dc.b $63,$61,$6E,$20,$6F,$6E,$6C,$79,$20,$61,$73,$73,$65,$6D,$62,$6C
	dc.b $65,$20,$65,$78,$65,$63,$75,$74,$61,$62,$6C,$65,$20,$63,$6F,$64
	dc.b $65,$20,$74,$6F,$20,$6D,$65,$6D,$6F,$72,$79,$00,$70,$72,$6F,$67
	dc.b $72,$61,$6D,$20,$62,$75,$66,$66,$65,$72,$20,$66,$75,$6C,$6C,$00
	dc.b $6C,$69,$6E,$6B,$65,$72,$20,$66,$6F,$72,$6D,$61,$74,$20,$72,$65
	dc.b $73,$74,$72,$69,$63,$74,$69,$6F,$6E,$00,$4F,$52,$47,$2F,$52,$4F
	dc.b $52,$47,$20,$6E,$6F,$74,$20,$61,$6C,$6C,$6F,$77,$65,$64,$00,$49
	dc.b $4E,$54,$45,$52,$4E,$41,$4C,$3A,$69,$6E,$76,$61,$6C,$69,$64,$20
	dc.b $6D,$75,$6C,$74,$69,$2D,$6C,$69,$6E,$65,$20,$6D,$61,$63,$72,$6F
	dc.b $20,$63,$61,$6C,$6C,$00,$63,$61,$6E,$6E,$6F,$74,$20,$6E,$65,$73
	dc.b $74,$20,$72,$65,$70,$65,$61,$74,$20,$6C,$6F,$6F,$70,$73,$00,$73
	dc.b $70,$75,$72,$69,$6F,$75,$73,$20,$45,$4E,$44,$52,$00,$69,$6E,$76
	dc.b $61,$6C,$69,$64,$20,$6E,$75,$6D,$65,$72,$69,$63,$20,$65,$78,$70
	dc.b $61,$6E,$73,$69,$6F,$6E,$00,$64,$75,$72,$69,$6E,$67,$20,$6C,$69
	dc.b $73,$74,$69,$6E,$67,$20,$6F,$75,$74,$70,$75,$74,$00,$69,$6E,$76
	dc.b $61,$6C,$69,$64,$20,$70,$72,$69,$6E,$74,$65,$72,$20,$70,$61,$72
	dc.b $61,$6D,$65,$74,$65,$72,$00,$69,$6E,$76,$61,$6C,$69,$64,$20,$46
	dc.b $4F,$52,$4D,$41,$54,$20,$70,$61,$72,$61,$6D,$65,$74,$65,$72,$00
	dc.b $49,$4E,$54,$45,$52,$4E,$41,$4C,$3A,$62,$61,$64,$20,$73,$65,$63
	dc.b $74,$69,$6F,$6E,$00,$49,$4E,$54,$45,$52,$4E,$41,$4C,$3A,$6D,$61
	dc.b $63,$72,$6F,$20,$6D,$65,$6D,$6F,$72,$79,$00,$61,$73,$73,$65,$6D
	dc.b $62,$6C,$79,$20,$69,$6E,$74,$65,$72,$72,$75,$70,$74,$65,$64,$00
	dc.b $69,$6E,$76,$61,$6C,$69,$64,$20,$73,$65,$63,$74,$69,$6F,$6E,$20
	dc.b $74,$79,$70,$65,$00,$69,$6E,$20,$63,$6F,$6D,$6D,$61,$6E,$64,$2D
	dc.b $6C,$69,$6E,$65,$20,$73,$79,$6D,$62,$6F,$6C,$00,$23,$20,$70,$72
	dc.b $6F,$62,$61,$62,$6C,$79,$20,$6D,$69,$73,$73,$69,$6E,$67,$00,$73
	dc.b $68,$6F,$72,$74,$20,$62,$72,$61,$6E,$63,$68,$20,$63,$61,$6E,$6E
	dc.b $6F,$74,$20,$62,$65,$20,$30,$20,$62,$79,$74,$65,$73,$00,$44,$43
	dc.b $42,$20,$6F,$72,$20,$44,$53,$20,$63,$6F,$75,$6E,$74,$20,$6D,$75
	dc.b $73,$74,$20,$6E,$6F,$74,$20,$62,$65,$20,$6E,$65,$67,$61,$74,$69
	dc.b $76,$65,$00,$69,$6E,$76,$61,$6C,$69,$64,$20,$62,$69,$74,$66,$69
	dc.b $65,$6C,$64,$20,$73,$70,$65,$63,$69,$66,$69,$63,$61,$74,$69,$6F
	dc.b $6E,$00,$63,$6F,$6C,$6F,$6E,$20,$28,$3A,$29,$20,$65,$78,$70,$65
	dc.b $63,$74,$65,$64,$00,$66,$6C,$6F,$61,$74,$69,$6E,$67,$2D,$70,$6F
	dc.b $69,$6E,$74,$20,$72,$65,$67,$69,$73,$74,$65,$72,$20,$65,$78,$70
	dc.b $65,$63,$74,$65,$64,$00,$4D,$4D,$55,$20,$72,$65,$67,$69,$73,$74
	dc.b $65,$72,$20,$65,$78,$70,$65,$63,$74,$65,$64,$00,$69,$6E,$76,$61
	dc.b $6C,$69,$64,$20,$4D,$4D,$55,$20,$66,$75,$6E,$63,$74,$69,$6F,$6E
	dc.b $20,$63,$6F,$64,$65,$00,$69,$6E,$76,$61,$6C,$69,$64,$20,$72,$61
	dc.b $64,$69,$78,$00,$69,$6E,$76,$61,$6C,$69,$64,$20,$36,$38,$30,$32
	dc.b $30,$20,$61,$64,$64,$72,$65,$73,$73,$69,$6E,$67,$20,$6D,$6F,$64
	dc.b $65,$00,$69,$6E,$76,$61,$6C,$69,$64,$20,$69,$6E,$64,$65,$78,$20
	dc.b $73,$63,$61,$6C,$65,$00,$68,$65,$78,$20,$66,$6C,$6F,$61,$74,$69
	dc.b $6E,$67,$20,$70,$6F,$69,$6E,$74,$20,$6E,$75,$6D,$62,$65,$72,$20
	dc.b $74,$6F,$6F,$20,$6C,$61,$72,$67,$65,$00,$69,$6E,$76,$61,$6C,$69
	dc.b $64,$20,$6F,$70,$63,$6F,$64,$65,$20,$73,$69,$7A,$65,$20,$66,$6F
	dc.b $72,$20,$64,$61,$74,$61,$2F,$61,$64,$64,$72,$65,$73,$73,$20,$72
	dc.b $65,$67,$69,$73,$74,$65,$72,$00,$6F,$6E,$6C,$79,$20,$46,$50,$49
	dc.b $41,$52,$20,$61,$6C,$6C,$6F,$77,$65,$64,$00,$6D,$61,$74,$68,$73
	dc.b $20,$63,$6F,$2D,$70,$72,$6F,$63,$65,$73,$73,$6F,$72,$20,$72,$65
	dc.b $71,$75,$69,$72,$65,$64,$00,$69,$6E,$76,$61,$6C,$69,$64,$20,$6B
	dc.b $2D,$66,$61,$63,$74,$6F,$72,$00,$66,$6C,$6F,$61,$74,$69,$6E,$67
	dc.b $20,$70,$6F,$69,$6E,$74,$20,$63,$6F,$6E,$73,$74,$61,$6E,$74,$20
	dc.b $6E,$6F,$74,$20,$61,$6C,$6C,$6F,$77,$65,$64,$00,$66,$6C,$6F,$61
	dc.b $74,$69,$6E,$67,$20,$70,$6F,$69,$6E,$74,$20,$63,$6F,$6E,$73,$74
	dc.b $61,$6E,$74,$20,$74,$6F,$6F,$20,$6C,$61,$72,$67,$65,$00,$62,$61
	dc.b $64,$20,$66,$6C,$6F,$61,$74,$69,$6E,$67,$20,$70,$6F,$69,$6E,$74
	dc.b $20,$65,$78,$70,$72,$65,$73,$73,$69,$6F,$6E,$00,$70,$72,$69,$76
	dc.b $69,$6C,$65,$67,$65,$64,$20,$69,$6E,$73,$74,$72,$75,$63,$74,$69
	dc.b $6F,$6E,$00,$69,$6E,$76,$61,$6C,$69,$64,$20,$73,$65,$63,$74,$69
	dc.b $6F,$6E,$20,$73,$70,$65,$63,$69,$66,$69,$65,$64,$00,$69,$6E,$76
	dc.b $61,$6C,$69,$64,$20,$70,$72,$65,$2D,$61,$73,$73,$65,$6D,$62,$6C
	dc.b $65,$64,$20,$66,$69,$6C,$65,$00,$6F,$6E,$6C,$79,$20,$28,$41,$6E
	dc.b $29,$20,$61,$6C,$6C,$6F,$77,$65,$64,$20,$66,$6F,$72,$20,$74,$68
	dc.b $69,$73,$20,$69,$6E,$73,$74,$72,$75,$63,$74,$69,$6F,$6E,$00,$49
	dc.b $4E,$54,$45,$52,$4E,$41,$4C,$3A,$6D,$65,$6D,$6F,$72,$79,$20,$6C
	dc.b $69,$73,$74,$20,$63,$6F,$72,$72,$75,$70,$74,$00,$62,$69,$74,$20
	dc.b $6E,$75,$6D,$62,$65,$72,$20,$73,$68,$6F,$75,$6C,$64,$20,$62,$65
	dc.b $20,$30,$2D,$37,$20,$66,$6F,$72,$20,$62,$79,$74,$65,$00,$70,$28
	dc.b $60,$4C
loc_0_00008422:
...
loc_0_000085C2:
	dc.b $73,$69,$67,$6E,$20,$65,$78,$74,$65,$6E,$64,$65,$64,$20,$6F,$70
	dc.b $65,$72,$61,$6E,$64,$00,$72,$65,$6C,$61,$74,$69,$76,$65,$20,$63
	dc.b $61,$6E,$6E,$6F,$74,$20,$62,$65,$20,$72,$65,$6C,$6F,$63,$61,$74
	dc.b $65,$64,$00,$69,$6E,$76,$61,$6C,$69,$64,$20,$4C,$49,$4E,$4B,$20
	dc.b $64,$69,$73,$70,$6C,$61,$63,$65,$6D,$65,$6E,$74,$00,$36,$38,$30
	dc.b $31,$30,$20,$69,$6E,$73,$74,$72,$75,$63,$74,$69,$6F,$6E,$2C,$20
	dc.b $63,$6F,$6E,$76,$65,$72,$74,$65,$64,$20,$74,$6F,$20,$4D,$4F,$56
	dc.b $45,$20,$53,$52,$00,$73,$69,$7A,$65,$20,$73,$68,$6F,$75,$6C,$64
	dc.b $20,$62,$65,$20,$2E,$57,$00,$64,$69,$72,$65,$63,$74,$69,$76,$65
	dc.b $20,$69,$67,$6E,$6F,$72,$65,$64,$00,$6D,$69,$73,$75,$73,$65,$20
	dc.b $6F,$66,$20,$72,$65,$67,$69,$73,$74,$65,$72,$20,$6C,$69,$73,$74
	dc.b $00,$6E,$6F,$20,$4F,$52,$47,$20,$73,$70,$65,$63,$69,$66,$69,$65
	dc.b $64,$00,$62,$69,$74,$20,$6E,$75,$6D,$62,$65,$72,$20,$73,$68,$6F
	dc.b $75,$6C,$64,$20,$62,$65,$20,$30,$2D,$37,$20,$66,$6F,$72,$20,$62
	dc.b $79,$74,$65,$00,$6D,$69,$73,$73,$69,$6E,$67,$20,$45,$4E,$44,$43
	dc.b $20,$61,$74,$20,$65,$6E,$64,$20,$6F,$66,$20,$6D,$61,$63,$72,$6F
	dc.b $00,$74,$72,$61,$69,$6C,$69,$6E,$67,$20,$63,$6F,$6D,$6D,$61,$20
	dc.b $61,$74,$20,$65,$6E,$64,$20,$6F,$66,$20,$44,$43,$20,$64,$69,$72
	dc.b $65,$63,$74,$69,$76,$65,$00,$62,$72,$61,$6E,$63,$68,$20,$6D,$61
	dc.b $64,$65,$20,$73,$68,$6F,$72,$74,$00,$6F,$66,$66,$73,$65,$74,$20
	dc.b $72,$65,$6D,$6F,$76,$65,$64,$00,$73,$68,$6F,$72,$74,$20,$77,$6F
	dc.b $72,$64,$20,$61,$64,$64,$72,$65,$73,$73,$69,$6E,$67,$20,$75,$73
	dc.b $65,$64,$00,$4D,$4F,$56,$45,$51,$20,$73,$75,$62,$73,$74,$69,$74
	dc.b $75,$74,$65,$64,$00,$71,$75,$69,$63,$6B,$20,$66,$6F,$72,$6D,$20
	dc.b $75,$73,$65,$64,$00,$62,$72,$61,$6E,$63,$68,$20,$63,$6F,$75,$6C
	dc.b $64,$20,$62,$65,$20,$73,$68,$6F,$72,$74,$00,$73,$68,$6F,$72,$74
	dc.b $20,$62,$72,$61,$6E,$63,$68,$20,$63,$6F,$6E,$76,$65,$72,$74,$65
	dc.b $64,$20,$74,$6F,$20,$4E,$4F,$50,$00,$62,$61,$73,$65,$20,$64,$69
	dc.b $73,$70,$6C,$61,$63,$65,$6D,$65,$6E,$74,$20,$73,$68,$6F,$72,$74
	dc.b $65,$6E,$65,$64,$00,$6F,$75,$74,$65,$72,$20,$64,$69,$73,$70,$6C
	dc.b $61,$63,$65,$6D,$65,$6E,$74,$20,$73,$68,$6F,$72,$74,$65,$6E,$65
	dc.b $64,$00,$41,$44,$44,$2F,$53,$55,$42,$20,$63,$6F,$6E,$76,$65,$72
	dc.b $74,$65,$64,$20,$74,$6F,$20,$4C,$45,$41,$00,$4C,$45,$41,$20,$63
	dc.b $6F,$6E,$76,$65,$72,$74,$65,$64,$20,$74,$6F,$20,$41,$44,$44,$51
	dc.b $2F,$53,$55,$42,$51,$00,$2E,$4C,$20,$63,$6F,$6E,$76,$65,$72,$74
	dc.b $65,$64,$20,$74,$6F,$20,$2E,$57,$00,$00,$02,$02,$02,$04,$00,$FF
	dc.b $00,$02,$02,$00,$02,$02,$4A,$2E,$02,$38,$67,$2C,$48,$A7,$C0,$00
	dc.b $04,$40,$00,$0C,$10,$3B,$00,$E4,$6B,$0A,$48,$80,$D1,$6E,$01,$94
	dc.b $52,$6E,$01,$92,$30,$17,$04,$40,$00,$0C,$32,$2E,$01,$10,$01,$01
	dc.b $4C,$9F,$00,$03,$66,$00,$FD,$54,$4E,$75,$70,$43,$60,$00,$FC,$2E
loc_0_00008842:
	movem.l a3-a5,-(a7)
	movea.l app_0172(a6),a2
...
loc_0_000088C4:
	move.l d4,$0098(a1)
	move.l app_017E(a6),$0010(a1)
	move.l a1,app_017E(a6)
	tst.l d1
...
loc_0_000090A8:
	move.l #$2800,d1
	move.w d1,app_0148(a6)
	bsr.b loc_0_000090BA
	move.l a0,app_013A(a6)
	rts
loc_0_000090BA:
	addq.l #4,d1
	bsr.w loc_0_0000AE42
	beq.b loc_0_000090EC
	move.l app_0136(a6),(a0)
	move.l a0,app_0136(a6)
	addq.w #4,a0
	rts
...
loc_0_000093A0:
	...
	bsr.w loc_0_0000A8C4
	bra.b loc_0_000093B0
loc_0_000093AC:
	bsr.w loc_0_0000A89E
loc_0_000093B0:
	movem.l (a7)+,d0-d2/a0-a2
	cmp.b #$A,d1
...
loc_0_000093FE:
	...
	dc.b $72,$3A,$20,$00,$4C,$6F,$63,$61,$6C,$73,$3A,$0A,$00,$57,$61,$72
	dc.b $6E,$69,$6E,$67,$3A,$20,$00,$20,$61,$74,$20,$6C,$69,$6E,$65,$20
	dc.b $00,$43,$6F,$75,$6C,$64,$20,$6E,$6F,$74,$20,$6F,$70,$65,$6E,$20
	dc.b $66,$69,$6C,$65,$20,$00,$20,$69,$6E,$20,$66,$69,$6C,$65,$20,$00
	dc.b $20,$62,$79,$74,$65,$73,$2C,$20,$00,$20,$6F,$70,$74,$69,$6D,$69
	dc.b $73,$61,$74,$69,$6F,$6E,$73,$20,$73,$61,$76,$69,$6E,$67,$20,$00
	dc.b $20,$62,$79,$74,$65,$73,$0A,$00,$20,$20,$50,$61,$67,$65,$20,$00
	dc.b $48,$69,$53,$6F,$66,$74,$20,$47,$65,$6E,$41,$6D,$20,$36,$38,$30
	dc.b $78,$30,$20,$4D,$61,$63,$72,$6F,$20,$41,$73,$73,$65,$6D,$62,$6C
	dc.b $65,$72,$20,$76,$33,$2E,$31,$38,$20,$20,$20,$00,$20,$72,$65,$6C
	dc.b $6F,$63,$61,$74,$61,$62,$6C,$65,$00,$20,$70,$6F,$73,$69,$74,$69
	dc.b $6F,$6E,$2D,$69,$6E,$64,$65,$70,$65,$6E,$64,$65,$6E,$74,$00,$20
	dc.b $63,$6F,$64,$65,$0A,$00,$0A,$09,$47,$4C,$4F,$42,$41,$4C,$20,$53
	dc.b $59,$4D,$42,$4F,$4C,$53,$0A,$0A,$00,$0A,$09,$4D,$4F,$44,$55,$4C
	dc.b $45,$20,$00,$20,$61,$62,$73,$6F,$6C,$75,$74,$65,$00,$42,$61,$64
	dc.b $20,$61,$72,$67,$75,$6D,$65,$6E,$74,$73,$0A,$00,$45,$72,$72,$6F
	dc.b $72,$20,$69,$6E,$20,$57,$49,$54,$48,$20,$66,$69,$6C,$65,$00,$57
	dc.b $49,$54,$48,$20,$66,$69,$6C,$65,$20,$6E,$6F,$74,$20,$66,$6F,$75
	dc.b $6E,$64,$00,$43,$6F,$75,$6C,$64,$20,$6E,$6F,$74,$20,$6F,$70,$65
	dc.b $6E,$20,$6C,$69,$73,$74,$69,$6E,$67,$20,$64,$65,$76,$69,$63,$65
	dc.b $0A,$00,$41,$73,$73,$65,$6D,$62,$6C,$69,$6E,$67,$20,$00,$20,$69
	dc.b $6E,$20,$61,$73,$73,$65,$6D,$62,$6C,$79,$20,$6F,$70,$74,$69,$6F
	dc.b $6E,$73,$00,$4D,$61,$69,$6E,$20,$66,$69,$6C,$65,$20,$61,$6C,$72
	dc.b $65,$61,$64,$79,$20,$69,$6E,$63,$6C,$75,$64,$65,$64,$20,$69,$6E
	dc.b $20,$68,$65,$61,$64,$65,$72,$20,$66,$69,$6C,$65,$0A,$00
loc_0_0000962C:
...
loc_0_000098EE:
	dc.b $08,$2E,$00,$02,$02,$1D,$66,$00,$60,$AC,$60,$00,$09,$D0
loc_0_000098FC:
	dc.b $4A,$2E,$01,$12,$66,$18,$B6,$3C,$00,$01,$66,$04,$50,$EE,$01,$14
	dc.b $08,$2E,$00,$02,$02,$1D,$66,$00,$60,$8A,$60,$00,$09,$9E,$4E,$75
loc_0_0000991C:
	dc.b $08,$2E,$00,$02,$02,$1D,$66,$00,$60,$7E,$60,$00,$09,$AE,$08,$2E
	dc.b $00,$02,$02,$1D,$66,$00,$60,$70,$60,$00,$09,$94
loc_0_00009938:
	dc.b $08,$2E,$00,$02,$02,$1D,$66,$00,$60,$62,$60,$00,$09,$86
loc_0_00009946:
	dc.b $08,$2E,$00,$02,$02,$1D,$66,$00,$60,$58,$60,$00,$09,$DC
loc_0_00009954:
	dc.b $08,$2E,$00,$02,$02,$1D,$66,$00,$60,$4A,$60,$00,$09,$FE
loc_0_00009962:
...
loc_0_0000A1FA:
	...
	dc.b $20,$6E,$01,$AA,$41,$E8,$00,$18,$4A,$90,$67,$0C,$20,$50,$4A,$68
	dc.b $00,$04,$66,$24,$4A,$90,$66,$F4,$48,$E7,$E0,$A0,$72,$5A,$61,$00
	dc.b $EE,$92,$4C,$DF,$06,$07,$22,$88,$42,$90,$31,$7C,$00,$0A,$00,$04
	dc.b $43,$E8,$00,$0A,$21,$49,$00,$06,$53,$68,$00,$04,$22,$68,$00,$06
	dc.b $50,$A8,$00,$06,$20,$49,$4E,$75,$20,$6E,$09,$40,$30,$18,$B0,$7C
	dc.b $2B,$2B,$66,$2C,$30,$18,$6A,$20,$02,$40,$00,$FF,$0C,$50,$2D,$2D
	dc.b $66,$16,$4A,$28,$00,$02,$6A,$10,$B0,$28,$00,$03,$66,$0A,$4A,$68
	dc.b $00,$04,$66,$0C,$58,$8F,$4E,$75,$4A,$50,$66,$04,$4A,$60,$4E,$75
	dc.b $70,$44,$60,$00,$E1,$FA,$D4,$AE,$02,$3C,$D4,$8D,$94,$AE,$02,$4C
	dc.b $4A,$2E,$01,$03,$67,$0A,$61,$00,$FF,$68,$30,$80,$21,$42,$00,$04
	dc.b $4E,$75,$24,$00,$30,$3C,$01,$00,$80,$2E,$01,$46,$60,$E2,$2A,$C2
	dc.b $61,$96,$6A,$08,$00,$40,$01,$00,$74,$FC,$60,$CA,$61,$00,$00,$A6
	dc.b $02,$FC,$3A,$C2,$61,$82,$6B,$B8,$61,$00,$00,$9A,$04,$FE,$0C,$6E
	dc.b $00,$03,$02,$1C,$66,$00,$00,$34,$3A,$C2,$B6,$3C,$00,$01,$67,$A0
	dc.b $20,$6E,$09,$40,$30,$18,$B0,$7C,$2B,$2B,$66,$94,$30,$18,$6A,$90
	dc.b $0C,$50,$2D,$2D,$66,$8A,$4A,$28,$00,$02,$6A,$84,$B0,$28,$00,$03
	dc.b $66,$F2,$4A,$68,$00,$04,$66,$EC,$4E,$75,$B6,$3C,$00,$01,$66,$B2
	dc.b $3A,$C2,$61,$00,$FF,$34,$6B,$04,$61,$4A,$07,$FE,$00,$40,$28,$00
	dc.b $74,$FE,$60,$00,$FF,$62,$0C,$6E,$00,$03,$02,$1C,$67,$00,$FF,$52
	dc.b $B6,$3C,$00,$01,$66,$20,$1A,$C2,$61,$00,$FF,$0E,$6B,$00,$00,$06
	dc.b $61,$22,$08,$FF,$00,$40,$29,$00,$74,$FF,$60,$00,$FF,$3A,$94,$AE
	dc.b $02,$4C,$D4,$8D,$55,$82,$1A,$C2,$61,$00,$FE,$EE,$6B,$00,$FF,$22
	dc.b $61,$02,$05,$FF,$4A,$2E,$01,$03,$67,$20,$61,$00,$FE,$94,$22,$57
	dc.b $10,$D9,$10,$EE,$01,$46,$30,$C0,$14,$19,$48,$82,$48,$C2,$D4,$AE
	dc.b $02,$3C,$D4,$8D,$94,$AE,$02,$4C,$20,$C2,$58,$8F,$4E,$75
loc_0_0000A396:
...
loc_0_0000A3C9:
	dc.b $2E,$6F,$00
loc_0_0000A3CC:
	dc.b $41,$6D,$69,$67,$61,$20,$65,$78,$65,$63,$75,$74,$61,$62,$6C,$65
	dc.b $00
loc_0_0000A3DD:
...
loc_0_0000A89E:
	...
	beq.b loc_0_0000A8BC
	movea.l app_0DF0(a6),a0
	move.b d1,(a0)+
	move.l a0,app_0DF0(a6)
	addq.w #1,app_0DEE(a6)
	cmp.b #$A,d1
	beq.b loc_0_0000A864
	rts
loc_0_0000A8BC:
	move.w d1,-(a7)
	bsr.b loc_0_0000A864
	move.w (a7)+,d1
	bra.b loc_0_0000A89E
loc_0_0000A8C4:
	move.w d1,-(a7)
...
loc_0_0000A968:
	...
	move.l a3,-(a7)
	bra.w loc_0_0000A890
loc_0_0000A986:
	movea.l d2,a0
	cmpi.l #1145394720,(a0)
	bne.b loc_0_0000A9B8
	move.l a0,app_01A2(a6)
	clr.l $0012(a0)
	clr.l $0016(a0)
	clr.l $001A(a0)
	clr.l $001E(a0)
	...
	bne.b loc_0_0000A9B8
	lea.l $0012(a0),a0
	move.l a0,app_019A(a6)
	addq.w #4,a0
	move.l a0,app_019E(a6)
loc_0_0000A9B8:
	moveq.l #0,d0
	rts
loc_0_0000A9BC:
...
loc_0_0000AAB6:
	dc.b $46,$52,$4F,$4D,$2F,$41,$2C,$54,$4F,$2F,$4B,$2C,$57,$49,$54,$48
	dc.b $2F,$4B,$2C,$49,$4E,$43,$44,$49,$52,$2F,$4B,$2F,$4D,$2C,$48,$45
	dc.b $41,$44,$45,$52,$2F,$4B,$2F,$4D,$2C,$51,$55,$49,$45,$54,$2F,$53
	dc.b $3A,$20,$00
loc_0_0000AAE9:
...
loc_0_0000AC8D:
	dc.b $50,$72,$65,$73,$73,$20,$61,$6E,$79,$20,$6B,$65,$79,$20,$74,$6F
	dc.b $20,$65,$78,$69,$74,$00,$00
loc_0_0000ACA4:
	bsr.w loc_0_0000A864
	tst.b app_0C26(a6)
...
loc_0_0000F9BF:
	dc.b $2E,$6D,$78,$00
loc_0_0000F9C3:
	dc.b $48,$49,$53,$4F,$46,$54,$20,$44,$45,$56,$50,$41,$43,$00,$00,$12
	dc.b $D8,$66,$FC,$53,$89,$4E,$75
loc_0_0000F9DA:
	bsr.w loc_0_0000A110
	lea.l app_01AE(a6),a2
	tst.b (a2)
