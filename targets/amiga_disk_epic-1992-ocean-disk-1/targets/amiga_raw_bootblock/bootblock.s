...
loc_0_00070018:
	...
	move a7,usp
	movea.l #$7FFF0,a7
	lea.l loc_0_0007020E(pc),a2
	move.l a1,(a2)
	bsr.w loc_0_0007010C
	lea.l loc_0_0007020E(pc),a5
	movea.l (a5),a1
	move.l #$400,$002C(a1)
	move.l #$4E00,$0024(a1)
	...
	movea.l $0004.w,a6
	jsr _LVODoIO(a6)
	lea.l loc_0_00070068(pc),a0
	move.l a0,m68k_vector_trap_3_instruction_vector.l
	trap #3
loc_0_00070068:
	move #$2700,sr
	lea.l loc_0_0007008C(pc),a0
	lea.l $00000400.l,a1
	move.w #$FF,d0
loc_0_0007007A:
	move.l (a0)+,(a1)+
	dbf.w d0,loc_0_0007007A
	move.l #$400,m68k_vector_trap_0_instruction_vector.l
	trap #0
loc_0_0007008C:
	move.w #$2FFF,d0
	lea.l $00020000.l,a0
...
loc_0_0007009C:
	move.b (a0)+,(a1)+
	dbf.w d0,loc_0_0007009C
	bsr.w loc_0_00070164
	jsr $0000086C.l
	jsr $00000898.l
	lea.l $00009C78.l,a0
loc_0_000700B8:
	move.l (a0),d0
	beq.b loc_0_000700C2
	lea.l $0008(a0),a0
	bra.b loc_0_000700B8
loc_0_000700C2:
	lea.l -$0008(a0),a0
	lea.l loc_0_00070108(pc),a1
	move.l (a0),(a1)
	move.l #$3864,d3
	lea.l loc_0_00070102(pc),a0
	move.l a0,d1
	move.l loc_0_00070108(pc),d2
	jsr $000008B0.l
	movea.l loc_0_00070108(pc),a0
	jmp (a0)
...
loc_0_00070108:
	ori.b #0,d0
loc_0_0007010C:
	bsr.b loc_0_00070164
	lea.l $00076CC0.l,a0
	move.w #$7CF,d0
	moveq.l #0,d1
loc_0_0007011A:
	move.l d1,(a0)+
	dbf.w d0,loc_0_0007011A
	bsr.b loc_0_00070164
	lea.l loc_0_000701A6(pc),a0
	lea.l $00077A6A.l,a1
	move.w #$19,d0
loc_0_00070130:
	move.l (a0)+,(a1)+
	lea.l $0024(a1),a1
	dbf.w d0,loc_0_00070130
	lea.l loc_0_00070172(pc),a0
	movea.l #$78C00,a1
	move.l a1,-(a7)
	move.w #$19,d0
loc_0_0007014A:
	move.w (a0)+,(a1)+
	dbf.w d0,loc_0_0007014A
	move.l #$FFFFFFFE,(a1)+
