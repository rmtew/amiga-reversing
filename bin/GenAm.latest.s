...
loc_0094:
    clr.b $06C8(a6)
    lea.l app_IO_10B8+IO_DATA(a6),a3
    bsr.w sub_4668
loc_00A0:
    lea.l $0832(a6),a3
    bsr.w sub_4668
...
loc_AA1A:
    ...
    moveq.l #0,d0
    lea.l app_TIMEVAL_10B0+TV_SIZE(a6),a1
    moveq.l #0,d0
    move.l a6,-(a7)
    movea.l $0004.w,a6
...
loc_AA4C:
    ...
    bne.s loc_AA70
loc_AA52:
    movea.l app_IO_10B8+IO_DEVICE(a6),a0
    cmpi.w #36,LIB_VERSION(a0)
    bcs.w loc_AA70
loc_AA60:
    lea.l app_TIMEVAL_10A8+TV_SECS(a6),a0
    pea.l (a6)
    movea.l app_IO_10B8+IO_DEVICE(a6),a6
...
loc_ABDE:
    ...
    bcs.w loc_AC58
loc_ABEC:
    lea.l app_TIMEVAL_10B0+TV_SECS(a6),a0
    pea.l (a6)
    movea.l app_IO_10B8+IO_DEVICE(a6),a6
    jsr _LVOGetSysTime(a6)
loc_ABFA:
    movea.l (a7)+,a6
    lea.l app_TIMEVAL_10B0+TV_SECS(a6),a0
    lea.l app_TIMEVAL_10A8+TV_SECS(a6),a1
    pea.l (a6)
    movea.l app_IO_10B8+IO_DEVICE(a6),a6
    jsr _LVOSubTime(a6)
loc_AC0E:
    ...
    bsr.w loc_9292
loc_AC18:
    move.l app_TIMEVAL_10B0+TV_SECS(a6),d1
    bsr.w sub_8F04
loc_AC20:
    moveq.l #46,d1
    bsr.w loc_9288
loc_AC26:
    ...
    move.l app_TIMEVAL_10B0+TV_MICRO(a6),d1
    bsr.w loc_8F08
loc_AC44:
    lea.l -$0006(a3),a0
    bsr.w loc_9292
...
loc_AEFE:
    ...
    beq.s loc_AF28
loc_AF04:
    lea.l app_IO_10B8+IOSTD_SIZE(a6),a2
    move.l a0,-(a7)
loc_AF0A:
    move.b (a0)+,(a2)+
    bne.s loc_AF0A
loc_AF0E:
    lea.l app_IO_10B8+IOSTD_SIZE(a6),a0
...
sub_FCD6:
    ...
    bra.s loc_FD10
sub_FCDA:
    movea.l app_IO_10B8+IO_DATA(a6),a0
loc_FCDE:
    tst.b (a0)
    beq.s loc_FD02
loc_FCE2:
    lea.l app_IO_10B8+IOSTD_SIZE(a6),a1
loc_FCE6:
    move.b (a0)+,(a1)+
    bne.s loc_FCE6
loc_FCEA:
