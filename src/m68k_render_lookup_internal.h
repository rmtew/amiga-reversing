...
typedef struct M68kBaseLayoutSlot {
...
typedef struct M68kBaseLayoutGroup {
  size_t start_index;
  size_t end_index;
  int32_t base_offset;
...
#define M68K_APP_BASE_SYMBOL "__amiga_app_base__"
#define M68K_APP_LAYOUT_NAME "app"
...
enum {
  ...
  M68K_RENDER_TYPED_PROVENANCE_POLICY_SEED = 11,
  M68K_RENDER_TYPED_PROVENANCE_STATIC_DATA = 12
};
