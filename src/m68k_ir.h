...
#define M68K_ANALYSIS_STRUCTURED_DATA_ITEM_LIMIT 4096U
#define M68K_ANALYSIS_NAMED_LABEL_LIMIT 4096U
...
typedef enum M68kPlatformUnresolvedTypedAccessClassification {
  ...
  M68K_PLATFORM_UNRESOLVED_TYPED_ACCESS_TYPE_CONFLICT = 3,
  M68K_PLATFORM_UNRESOLVED_TYPED_ACCESS_INDEXED_DYNAMIC = 4,
  M68K_PLATFORM_UNRESOLVED_TYPED_ACCESS_AUTO_UPDATE_CURSOR = 5
...
typedef enum M68kPlatformTypeProvenanceKind {
  ...
  M68K_PLATFORM_TYPE_PROVENANCE_STATIC_DATA = 12
...
typedef enum M68kPlatformCallNoteKind {
  ...
  M68K_PLATFORM_CALL_NOTE_LOCAL_HELPER_SYMBOL = 6
...
typedef enum M68kPlatformAddressUseShape {
  ...
  M68K_PLATFORM_ADDRESS_USE_SHAPE_HARDWARE_BASE_ADDRESS = 6
...
typedef enum M68kPlatformSemanticUseKind {
  ...
  M68K_PLATFORM_SEMANTIC_USE_AUDIO_REGISTER = 11,
  M68K_PLATFORM_SEMANTIC_USE_HARDWARE_ACCESS = 12,
  M68K_PLATFORM_SEMANTIC_USE_HARDWARE_VALUE = 13,
  ...
  M68K_PLATFORM_SEMANTIC_USE_PLATFORM_CALL_INPUT = 19,
  M68K_PLATFORM_SEMANTIC_USE_PLATFORM_STACK_CLEANUP = 20,
  M68K_PLATFORM_SEMANTIC_USE_RUNTIME_SINK_POINTER = 21
...
typedef enum M68kSourceQualityDiagnosticKind {
  ...
  M68K_SOURCE_QUALITY_DIAGNOSTIC_ACCEPTED_CODE_WITHOUT_EXECUTABLE_ORIGIN = 7,
  M68K_SOURCE_QUALITY_DIAGNOSTIC_UNREFERENCED_LABEL_STATEMENT = 8,
  M68K_SOURCE_QUALITY_DIAGNOSTIC_PARTIAL_CODE_BLOCK_DECODE = 9,
  M68K_SOURCE_QUALITY_DIAGNOSTIC_EXPECTED_SYMBOL_ACCESS_WITHOUT_PRODUCER = 10,
  M68K_SOURCE_QUALITY_DIAGNOSTIC_PLATFORM_OPERAND_EXPR_WITHOUT_EXPECTED_ACCESS = 11
...
typedef enum M68kSymbolOriginKind {
  ...
  M68K_SYMBOL_ORIGIN_ANALYSIS_LABEL = 1,
  ...
  M68K_SYMBOL_ORIGIN_STRUCTURED_DATA = 8,
  M68K_SYMBOL_ORIGIN_OBJECT_SYMBOL = 9
...
typedef enum M68kCodeOriginEvidenceKind {
  ...
  M68K_CODE_ORIGIN_EVIDENCE_FALLTHROUGH = 4,
  M68K_CODE_ORIGIN_EVIDENCE_INLINE_RESUME = 5,
  M68K_CODE_ORIGIN_EVIDENCE_RUNTIME_VIEW_ENTRY = 6,
  M68K_CODE_ORIGIN_EVIDENCE_LINKAGE_API_ENTRY = 7,
  M68K_CODE_ORIGIN_EVIDENCE_PLATFORM_LOADSEG_ENTRY = 8,
  M68K_CODE_ORIGIN_EVIDENCE_STACK_CONTINUATION = 9,
  M68K_CODE_ORIGIN_EVIDENCE_BOUNDARY_API_ENTRY = 10,
  M68K_CODE_ORIGIN_EVIDENCE_RUNTIME_CONTROL_TARGET = 11,
  M68K_CODE_ORIGIN_EVIDENCE_DIRECT_CONTROL_TARGET = 12,
  M68K_CODE_ORIGIN_EVIDENCE_RELOCATION_CONTROL_TARGET = 13,
  M68K_CODE_ORIGIN_EVIDENCE_TRACED_INDIRECT_CONTROL_TARGET = 14,
...
int m68k_ir_section_analysis_append_recovered_platform_unresolved_typed_access(
    ...
    uint8_t base_reg, int32_t displacement, uint16_t struct_size, uint8_t access_size, const char *root_struct_name,
