...
class TargetUsageManifestTests(unittest.TestCase):
    ...
    def test_extracts_structured_analysis_and_listing_features(self) -> None:
                    ...
                    "table_records": [
                        {
                            ...
                            "entry_count": 2,
                            "role_flags": 8,
                            "role": "stale_display_name",
                            "table_kind_id": 3,
                            "table_kind": "stale_display_name",
                            "source_pattern_id": 2,
                            "source_pattern": "stale_display_name",
                            "base_expression_id": 2,
                            "base_expression": "stale_display_name",
                            "target_section": 0,
                            "target_offset": 0x94,
                            "consumer_section": 0,
        ...
        self.assertNotIn("memory-layout:conflict:code_overlap", counts)
        self.assertEqual(counts["memory-layout:conflict_state:code_overlap"], 1)
        self.assertEqual(counts["memory-layout:conflict_state:unresolved"], 1)
    ...
    def test_project_target_metadata_features_include_decompressed_child(self) -> None:
        entry = {
            ...
            "status": "ok",
            "origin": {},
            "project_origin_kind": "stale_display_name",
            "project_origin_kind_id": 1,
            "target_role": "stale_display_name",
            "target_role_id": 1,
            "payload_role": "stale_display_name",
            "payload_role_id": 2,
    ...
    def test_builds_xrefs_from_structured_analysis_and_listing_metadata(self) -> None:
        ...
        self.assertNotIn(("memory-layout:conflict:code_overlap", "memory_layout", 0x60, 5), by_feature)
        self.assertIn(("memory-layout:conflict_state:code_overlap", "memory_layout", 0x60, 5), by_feature)
        ...
        self.assertIn(("memory-layout:conflict_state:unresolved", "memory_layout", 0x84, 8), by_feature)
