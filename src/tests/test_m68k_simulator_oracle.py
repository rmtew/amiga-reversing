...
def _oracle_case_cache() -> tuple[OracleCase, ...]:
    return (
        ...
        OracleCase("move-byte-clears-stale-zero", "core", "move.b (a0)+,d1", a=(0x20,), d=(0, 0xAAAAAAAA),
            sr=0x0004, compare_sr=True, memory_size=0x40, memory_writes=((0x20, b"\x05"),)),
        OracleCase("move-byte-sets-zero", "core", "move.b (a0)+,d1", a=(0x20,), d=(0, 0xAAAAAAAA),
            sr=0x0000, compare_sr=True, memory_size=0x40, memory_writes=((0x20, b"\x00"),)),
