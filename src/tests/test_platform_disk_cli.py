...
class PlatformDiskCliTests(unittest.TestCase):
    ...
    def test_inspect_disk_amiga_json(self) -> None:
        ...
        self.assertEqual(boot_import["source"]["entrypoint"], 0x7000C)
        self.assertEqual(boot_import["source"]["code_start_offset"], 0x0C)
        ...
        self.assertEqual(boot_import["target_metadata"]["entry_register_seeds"][0]["register"], "A6")
        self.assertEqual(boot_import["target_metadata"]["entry_register_seeds"][1]["context_name"], "trackdisk.device")
