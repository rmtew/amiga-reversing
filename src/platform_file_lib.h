...
PLATFORM_FILE_API int platform_file_facts_v2_listing_rows_with_analysis_and_text_path_json_alloc(
    const char *backend_name, const char *path, const char *metadata_path, const char *include_dir, char **out_text);
...
PLATFORM_FILE_API int platform_file_facts_v2_listing_rows_with_analysis_and_text_raw_path_json_alloc(
    const char *platform_name, const char *path, uint32_t entry_offset, const char *metadata_path,
    const char *include_dir, char **out_text);
