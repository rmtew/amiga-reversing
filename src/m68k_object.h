...
typedef enum M68kContainerLayoutKind {
  ...
  M68K_CONTAINER_LAYOUT_ATARI_ST_PRG_CONTAINER = 5,
  M68K_CONTAINER_LAYOUT_ATARI_ST_PRG_HEADER = 6,
  M68K_CONTAINER_LAYOUT_ATARI_ST_PRG_RELOCATION_STREAM = 7
...
typedef enum M68kContainerEncodingKind {
  ...
  M68K_CONTAINER_ENCODING_ATARI_ST_PRG_HEADER_FIELD = 4,
  M68K_CONTAINER_ENCODING_ATARI_ST_PRG_RELOCATION_TERMINATOR = 5
} M68kContainerEncodingKind;

typedef enum M68kAtariStPrgRelocationTerminatorKind {
  M68K_ATARI_ST_PRG_RELOCATION_TERMINATOR_NONE = 0,
  M68K_ATARI_ST_PRG_RELOCATION_TERMINATOR_ZERO_BYTE = 1,
  M68K_ATARI_ST_PRG_RELOCATION_TERMINATOR_EOF = 2
} M68kAtariStPrgRelocationTerminatorKind;
