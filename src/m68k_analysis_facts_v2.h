...
#define M68K_FACTS_V2_CODE_START_REASON_STACK_CONTINUATION 10U
#define M68K_FACTS_V2_CODE_START_REASON_BOUNDARY_API_ENTRY 11U
...
typedef struct M68kFactsV2Profile {
  ...
  double platform_analysis_pass_seconds;
  double platform_analysis_base_slot_seconds;
  double platform_analysis_call_summary_seconds;
  double platform_analysis_typed_ref_seconds;
  double platform_analysis_call_comment_seconds;
  double platform_analysis_app_slot_seconds;
  double platform_analysis_runtime_data_seconds;
  double platform_analysis_hardware_data_seconds;
  double platform_analysis_generic_data_seconds;
