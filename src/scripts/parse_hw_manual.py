...
Usage:
    ...
    uv run python -m src.scripts.parse_hw_manual resources/Hardware_Manual.html --output json --outfile knowledge/amiga_hw_registers.json
    uv run python -m src.scripts.parse_hw_manual resources/Hardware_Manual.html --output md --outfile knowledge/amiga_hw_reference.md
"""
