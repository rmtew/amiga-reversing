...
static int test_facts_v2_macos_call_stack_args_from_generated_metadata(void) {
  ...
  M68K_C_ASSERT_U32(1U, (uint32_t)analysis_section->recovered_platform_typed_access_count);
  M68K_C_ASSERT_U32(14U, analysis_section->recovered_platform_typed_accesses[0].offset);
  ...
  M68K_C_ASSERT_INT(-258, analysis_section->recovered_platform_typed_accesses[0].displacement);
  M68K_C_ASSERT_U32(0U, analysis_section->recovered_platform_typed_accesses[0].struct_size);
  M68K_C_ASSERT_U32(2U, analysis_section->recovered_platform_typed_accesses[0].field_size);
