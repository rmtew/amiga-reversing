...
def _manual_action_application_payload(
    ...
    elif kind == "create_manual_runtime_observation_view":
        view = action_payload.get("runtime_observation_view")
        if isinstance(view, Mapping):
            local_effects.append({"kind": "runtime_observation_view", "runtime_observation_view": dict(view)})
    elif kind == "remove_manual_runtime_observation_view":
        view = action_payload.get("runtime_observation_view")
        if isinstance(view, Mapping):
