...
- [x] Ambiguous references expose a catalog navigation action distinct from direct follow.
- [x] Ctrl-modified navigation opens or focuses the matching Navigate detail list.
- [x] The selected reference context is preserved in the detail list where possible.
- [x] Tests cover ambiguous reference behavior and Escape dismissal compatibility.
