...
- [ ] Temporary platform disk/container parse state does not escape the Workflow Arena.
- [ ] Returned platform disk/container parser results own durable internals through a Result Arena.
- [ ] Existing import and reproduction behavior remains unchanged.
- [ ] Before/after notes report raw heap allocation site count changes in touched disk/container parser code.
