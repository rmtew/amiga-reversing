...
- [x] Registry exposes default bindings for palette, review, navigate, history, and row navigation commands.
- [x] Registry can represent unbound commands.
- [x] Catalog/palette data can show binding badges from the registry.
- [x] Existing keyboard behavior is routed through the registry where practical.
- [x] Web tests cover bound and unbound command display metadata.
