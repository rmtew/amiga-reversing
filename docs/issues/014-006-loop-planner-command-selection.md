Status: Implementation complete for supported 014 planner surface; future feed widening deferred
...
- Data-block clear-type already-satisfied checks now require the active binding
  ...
  clear candidate.
- Seeded-item correction already-satisfied checks now compare suppression
