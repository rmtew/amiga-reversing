...
- [x] Backend catalog entries cover the current Review panel actions for all existing review item kinds.
- [x] Catalog entries include stable id, label, enabled state, target context, log/transient marker, and parameter shape.
- [x] The Review panel renders actions from catalog data without duplicating eligibility logic.
- [x] Backend and web tests cover representative review item kinds.
