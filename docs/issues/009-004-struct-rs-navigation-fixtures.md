...
- [ ] Test fixtures include at least one struct or RS-style reference when supported by current analysis output.
- [ ] Navigation commands can identify and follow or open details for the fixture reference.
- [ ] If current fixtures cannot support this honestly, document the missing analysis prerequisite and create a follow-up issue.
- [ ] Tests cover the supported struct/RS-style path or the documented prerequisite.
