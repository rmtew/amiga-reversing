...
- [ ] Facts IR returned arrays are owned by a Result Arena.
- [ ] Destroy tears down the result arena rather than freeing migrated arrays piecemeal.
- [ ] No facts IR returned pointer depends on a Workflow Arena.
- [ ] Before/after notes report raw heap allocation site count changes in touched facts code.
