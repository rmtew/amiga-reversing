...
- [x] Review catalog shape, API behavior, CLI behavior, web integration, and tests against PRD 006.
- [x] Remove unnecessary complexity or duplicated action rules found during review.
- [x] Add missing tests or issue follow-ups for work that should not be fixed in this slice.
- [x] PRD 006 links and issue statuses remain accurate after review.
