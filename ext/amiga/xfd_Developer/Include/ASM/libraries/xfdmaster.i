...
**
**	$VER: xfdmaster.i 39.5 (31.08.2002)
**
...
;======================================================================
	...
	BITDEF	XFDF,MASTERALLOC,4	; (V39) master allocated decrunch buffer
...
XFDID_SACFPQCruncher		EQU	(XFDID_BASE+$007a) * disabled
...
XFDID_PPbk			EQU	(XFDID_BASE+$0084)
XFDID_StoneCracker292Data	EQU	(XFDID_BASE+$0085)
XFDID_MegaCruncherObj		EQU	(XFDID_BASE+$0086)
XFDID_DeluxeCruncher1		EQU	(XFDID_BASE+$0087)
XFDID_DeluxeCruncher3		EQU	(XFDID_BASE+$0088)
XFDID_ByteKiller97		EQU	(XFDID_BASE+$0089)
XFDID_TurboSqueezer51		EQU	(XFDID_BASE+$008A)
XFDID_SubPacker10		EQU	(XFDID_BASE+$008B)
XFDID_StoneCracker404Lib	EQU	(XFDID_BASE+$008C)
XFDID_ISC_Pass1			EQU	(XFDID_BASE+$008D)
XFDID_ISC_Pass2			EQU	(XFDID_BASE+$008E)
XFDID_ISC_Pass3			EQU	(XFDID_BASE+$008F)
XFDID_PCompressFALH		EQU	(XFDID_BASE+$0090)
XFDID_PCompressHILH		EQU	(XFDID_BASE+$0091)
XFDID_SMF			EQU	(XFDID_BASE+$0092)
XFDID_DefJamCruncher32T		EQU	(XFDID_BASE+$0093)
