...
def test_gen_disasm_renders_with_selected_assembler_profile(monkeypatch, tmp_path: Path) -> None:
    calls: list[dict[str, object]] = []
    output_path = tmp_path / "out.s"

    def fake_render(binary_path: str, *, syntax: str, project_root=None) -> str:
        calls.append({"binary_path": binary_path, "syntax": syntax})
    ...
    assert calls == [{"binary_path": "bin/demo", "syntax": "genam"}]
